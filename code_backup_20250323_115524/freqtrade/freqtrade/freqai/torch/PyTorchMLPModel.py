...
# REMOVED_UNUSED_CODE: class FeedForward(nn.Module):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     A simple fully-connected feedforward neural network block.
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     :param hidden_dim: The number of hidden units in the block.
# REMOVED_UNUSED_CODE:     :return: torch.Tensor. with shape (batch_size, hidden_dim)
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     def __init__(self, hidden_dim: int):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         super().__init__()
