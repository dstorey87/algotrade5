...
# REMOVED_UNUSED_CODE: from freqtrade.optimize.hyperopt_tools import HyperoptTools
...
# REMOVED_UNUSED_CODE: def detect_parameters(
# REMOVED_UNUSED_CODE:     obj: HyperStrategyMixin | type[HyperStrategyMixin], category: str
# REMOVED_UNUSED_CODE: ) -> Iterator[tuple[str, BaseParameter]]:
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Detect all parameters for 'category' for "obj"
# REMOVED_UNUSED_CODE:     :param obj: Strategy object or class
# REMOVED_UNUSED_CODE:     :param category: category - usually `'buy', 'sell', 'protection',...
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     for attr_name in dir(obj):
# REMOVED_UNUSED_CODE:         if not attr_name.startswith("__"):  # Ignore internals, not strictly necessary.
# REMOVED_UNUSED_CODE:             attr = getattr(obj, attr_name)
# REMOVED_UNUSED_CODE:             if issubclass(attr.__class__, BaseParameter):
# REMOVED_UNUSED_CODE:                 if (
# REMOVED_UNUSED_CODE:                     attr_name.startswith(category + "_")
# REMOVED_UNUSED_CODE:                     and attr.category is not None
# REMOVED_UNUSED_CODE:                     and attr.category != category
# REMOVED_UNUSED_CODE:                 ):
# REMOVED_UNUSED_CODE:                     raise OperationalException(
# REMOVED_UNUSED_CODE:                         f"Inconclusive parameter name {attr_name}, category: {attr.category}."
# REMOVED_UNUSED_CODE:                     )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 if category == attr.category or (
# REMOVED_UNUSED_CODE:                     attr_name.startswith(category + "_") and attr.category is None
# REMOVED_UNUSED_CODE:                 ):
# REMOVED_UNUSED_CODE:                     yield attr_name, attr
