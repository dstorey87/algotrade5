...
# REMOVED_UNUSED_CODE:     def check_dict(current_dict: dict, element: str):
# REMOVED_UNUSED_CODE:         if element in current_dict:
# REMOVED_UNUSED_CODE:             element = current_dict[element]
# REMOVED_UNUSED_CODE:         return element
