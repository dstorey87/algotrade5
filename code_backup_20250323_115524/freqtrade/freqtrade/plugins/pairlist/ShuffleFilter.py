...
# REMOVED_UNUSED_CODE: from typing import Literal
...
# REMOVED_UNUSED_CODE: from freqtrade.util.periodic_cache import PeriodicCache


# REMOVED_UNUSED_CODE: logger = logging.getLogger(__name__)

# REMOVED_UNUSED_CODE: ShuffleValues = Literal["candle", "iteration"]
