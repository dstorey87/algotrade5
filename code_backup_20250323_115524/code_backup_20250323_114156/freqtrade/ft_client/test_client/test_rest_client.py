...
import pytest
# REMOVED_UNUSED_CODE: from requests.exceptions import ConnectionError as RequestsConnectionError
...
# REMOVED_UNUSED_CODE:     client._session.request = request_mock
...
# REMOVED_UNUSED_CODE:     client._session.request = MagicMock(side_effect=RequestsConnectionError())
