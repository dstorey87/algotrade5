...
# REMOVED_UNUSED_CODE:     def from_files(files: list[str]) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Iterate through the config files passed in, loading all of them
# REMOVED_UNUSED_CODE:         and merging their contents.
# REMOVED_UNUSED_CODE:         Files are loaded in sequence, parameters in later configuration files
# REMOVED_UNUSED_CODE:         override the same parameter from an earlier file (last definition wins).
# REMOVED_UNUSED_CODE:         Runs through the whole Configuration initialization, so all expected config entries
# REMOVED_UNUSED_CODE:         are available to interactive environments.
# REMOVED_UNUSED_CODE:         :param files: List of file paths
# REMOVED_UNUSED_CODE:         :return: configuration dictionary
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         # Keep this method as staticmethod, so it can be used from interactive environments
# REMOVED_UNUSED_CODE:         c = Configuration({"config": files}, RunMode.OTHER)
# REMOVED_UNUSED_CODE:         return c.get_config()
