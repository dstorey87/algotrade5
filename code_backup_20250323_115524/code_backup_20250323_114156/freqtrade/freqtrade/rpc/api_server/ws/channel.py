...
# REMOVED_UNUSED_CODE:         self._subscriptions: list[str] = []
...
# REMOVED_UNUSED_CODE:     def set_subscriptions(self, subscriptions: list[str]) -> None:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Set which subscriptions this channel is subscribed to
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         :param subscriptions: List of subscriptions, List[str]
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         self._subscriptions = subscriptions

# REMOVED_UNUSED_CODE:     def subscribed_to(self, message_type: str) -> bool:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Check if this channel is subscribed to the message_type
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         :param message_type: The message type to check
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return message_type in self._subscriptions

# REMOVED_UNUSED_CODE:     async def run_channel_tasks(self, *tasks, **kwargs):
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Create and await on the channel tasks unless an exception
# REMOVED_UNUSED_CODE:         was raised, then cancel them all.
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         :params *tasks: All coros or tasks to be run concurrently
# REMOVED_UNUSED_CODE:         :param **kwargs: Any extra kwargs to pass to gather
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if not self.is_closed():
# REMOVED_UNUSED_CODE:             # Wrap the coros into tasks if they aren't already
# REMOVED_UNUSED_CODE:             self._channel_tasks = [
# REMOVED_UNUSED_CODE:                 task if isinstance(task, asyncio.Task) else asyncio.create_task(task)
# REMOVED_UNUSED_CODE:                 for task in tasks
# REMOVED_UNUSED_CODE:             ]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             try:
# REMOVED_UNUSED_CODE:                 return await asyncio.gather(*self._channel_tasks, **kwargs)
# REMOVED_UNUSED_CODE:             except Exception:
# REMOVED_UNUSED_CODE:                 # If an exception occurred, cancel the rest of the tasks
# REMOVED_UNUSED_CODE:                 await self.cancel_channel_tasks()

# REMOVED_UNUSED_CODE:     async def cancel_channel_tasks(self):
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Cancel and wait on all channel tasks
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         for task in self._channel_tasks:
# REMOVED_UNUSED_CODE:             task.cancel()
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             # Wait for tasks to finish cancelling
# REMOVED_UNUSED_CODE:             try:
# REMOVED_UNUSED_CODE:                 await task
# REMOVED_UNUSED_CODE:             except (
# REMOVED_UNUSED_CODE:                 asyncio.CancelledError,
# REMOVED_UNUSED_CODE:                 asyncio.TimeoutError,
# REMOVED_UNUSED_CODE:                 WebSocketDisconnect,
# REMOVED_UNUSED_CODE:                 ConnectionClosed,
# REMOVED_UNUSED_CODE:                 RuntimeError,
# REMOVED_UNUSED_CODE:             ):
# REMOVED_UNUSED_CODE:                 pass
# REMOVED_UNUSED_CODE:             except Exception as e:
# REMOVED_UNUSED_CODE:                 logger.info(f"Encountered unknown exception: {e}", exc_info=e)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         self._channel_tasks = []
