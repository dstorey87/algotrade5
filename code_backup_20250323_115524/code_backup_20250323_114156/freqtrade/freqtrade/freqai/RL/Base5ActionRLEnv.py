...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Long_enter = 1
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Long_exit = 2
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Short_enter = 3
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Short_exit = 4


# REMOVED_UNUSED_CODE: class Base5ActionRLEnv(BaseEnvironment):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Base class for a 5 action environment
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._last_trade_tick = self._current_tick
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             elif action == Actions.Long_exit.value:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._update_total_profit()
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._position = Positions.Neutral
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 trade_type = "exit_long"
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._last_trade_tick = None
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             elif action == Actions.Short_exit.value:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._update_total_profit()
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._position = Positions.Neutral
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 trade_type = "exit_short"
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 self._last_trade_tick = None
...
# REMOVED_UNUSED_CODE:             or (action == Actions.Short_exit.value and self._position == Positions.Long)
# REMOVED_UNUSED_CODE:             or (action == Actions.Short_exit.value and self._position == Positions.Neutral)
...
# REMOVED_UNUSED_CODE:             or (action == Actions.Long_exit.value and self._position == Positions.Short)
# REMOVED_UNUSED_CODE:             or (action == Actions.Long_exit.value and self._position == Positions.Neutral)
# REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     def _is_valid(self, action: int) -> bool:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         # trade signal
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         if action in (Actions.Short_exit.value, Actions.Long_exit.value):
