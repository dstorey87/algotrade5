...
# REMOVED_UNUSED_CODE:     _STRATEGY.can_short = True
...
# REMOVED_UNUSED_CODE:     _STRATEGY.can_short = False
...
# REMOVED_UNUSED_CODE:     strategy.ignore_buying_expired_candle_after = 60
...
# REMOVED_UNUSED_CODE:     _STRATEGY.disable_dataframe_checks = True
    caplog.clear()
    _STRATEGY.assert_df(
        ohlcv_history,
        len(ohlcv_history),
...
# REMOVED_UNUSED_CODE:     _STRATEGY.disable_dataframe_checks = False
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            0.998,
            ExitType.TRAILING_STOP_LOSS,
# REMOVED_UNUSED_CODE:             lambda **kwargs: -0.05,
        ),
        (
            0.05,
            0.998,
...
# REMOVED_UNUSED_CODE:             lambda **kwargs: -0.05,
        ...
        (
            ...
            0.981,
            ExitType.NONE,
# REMOVED_UNUSED_CODE:             lambda current_profit, **kwargs: (
# REMOVED_UNUSED_CODE:                 -0.1 if current_profit < 0.6 else -(current_profit * 2)
# REMOVED_UNUSED_CODE:             ),
        ),
        ...
        (
            ...
            0.9,
            ExitType.NONE,
# REMOVED_UNUSED_CODE:             lambda **kwargs: None,
        ),
        ...
        (
            ...
            0.9,
            ExitType.NONE,
# REMOVED_UNUSED_CODE:             lambda **kwargs: math.inf,
        ),
    ],
)
def test_ft_stoploss_reached(
    ...
    expected,
    liq,
# REMOVED_UNUSED_CODE:     trailing,
# REMOVED_UNUSED_CODE:     custom,
    profit2,
    adjusted2,
    expected2,
    custom_stop,
...
# REMOVED_UNUSED_CODE:     strategy.trailing_stop = trailing
# REMOVED_UNUSED_CODE:     strategy.trailing_stop_positive = -0.05
# REMOVED_UNUSED_CODE:     strategy.use_custom_stoploss = custom
...
# REMOVED_UNUSED_CODE:     strategy.custom_exit = MagicMock(return_value=True)
    res = strategy.should_exit(trade, 1, now, enter=False, exit_=False, low=None, high=None)
    assert res[0].exit_flag is True
    assert res[0].exit_type == ExitType.CUSTOM_EXIT
    assert res[0].exit_reason == "custom_exit"

# REMOVED_UNUSED_CODE:     strategy.custom_exit = MagicMock(return_value="hello world")
    ...
    caplog.clear()
# REMOVED_UNUSED_CODE:     strategy.custom_exit = MagicMock(return_value="h" * CUSTOM_TAG_MAX_LENGTH * 2)
    res = strategy.should_exit(trade, 1, now, enter=False, exit_=False, low=None, high=None)
    assert res[0].exit_type == ExitType.CUSTOM_EXIT
    assert res[0].exit_flag is True
...
# REMOVED_UNUSED_CODE:     ind_mock = MagicMock(side_effect=lambda x, meta: x)
# REMOVED_UNUSED_CODE:     entry_mock = MagicMock(side_effect=lambda x, meta: x)
# REMOVED_UNUSED_CODE:     exit_mock = MagicMock(side_effect=lambda x, meta: x)
...
# REMOVED_UNUSED_CODE:     strategy.process_only_new_candles = True
...
# REMOVED_UNUSED_CODE:     PairLocks.timeframe = default_conf["timeframe"]
# REMOVED_UNUSED_CODE:     PairLocks.use_db = True
    strategy = StrategyResolver.load_strategy(default_conf)
...
# REMOVED_UNUSED_CODE:     strategy.timeframe = "15m"
...
# REMOVED_UNUSED_CODE:     intpar.in_space = True
...
# REMOVED_UNUSED_CODE:     fltpar.in_space = True
...
# REMOVED_UNUSED_CODE:     catpar.in_space = True
...
# REMOVED_UNUSED_CODE:     boolpar.in_space = True
