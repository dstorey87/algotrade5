...
# REMOVED_UNUSED_CODE:     BOT_START_TIME = "bot_start_time"
# REMOVED_UNUSED_CODE:     STARTUP_TIME = "startup_time"
...
# REMOVED_UNUSED_CODE: def set_startup_time():
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     sets bot_start_time to the first trade open date - or "now" on new databases.
# REMOVED_UNUSED_CODE:     sets startup_time to "now"
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     st = KeyValueStore.get_value("bot_start_time")
# REMOVED_UNUSED_CODE:     if st is None:
# REMOVED_UNUSED_CODE:         from freqtrade.persistence import Trade
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         t = Trade.session.query(Trade).order_by(Trade.open_date.asc()).first()
# REMOVED_UNUSED_CODE:         if t is not None:
# REMOVED_UNUSED_CODE:             KeyValueStore.store_value("bot_start_time", t.open_date_utc)
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             KeyValueStore.store_value("bot_start_time", datetime.now(timezone.utc))
# REMOVED_UNUSED_CODE:     KeyValueStore.store_value("startup_time", datetime.now(timezone.utc))
