...
# REMOVED_UNUSED_CODE:     media_type = "application/json"

# REMOVED_UNUSED_CODE:     def render(self, content: Any) -> bytes:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Use rapidjson for responses
# REMOVED_UNUSED_CODE:         Handles NaN and Inf / -Inf in a javascript way by default.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return orjson.dumps(content, option=orjson.OPT_SERIALIZE_NUMPY)
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     def __new__(cls, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         This class is a singleton.
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         We'll only have one instance of it around.
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         if ApiServer.__instance is None:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             ApiServer.__instance = object.__new__(cls)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             ApiServer.__initialized = False
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         return ApiServer.__instance
...
# REMOVED_UNUSED_CODE:     def add_rpc_handler(self, rpc: RPC):
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Attach rpc handler
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if not ApiServer._has_rpc:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             ApiServer._rpc = rpc
# REMOVED_UNUSED_CODE:             ApiServer._has_rpc = True
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             # This should not happen assuming we didn't mess up.
# REMOVED_UNUSED_CODE:             raise OperationalException("RPC Handler already attached.")

    def cleanup(self) -> None:
        """Cleanup pending module resources"""
        ApiServer._has_rpc = False
        del ApiServer._rpc
# REMOVED_UNUSED_CODE:         ApiBG.exchanges = {}
# REMOVED_UNUSED_CODE:         ApiBG.jobs = {}
...
# REMOVED_UNUSED_CODE:     @classmethod
    def shutdown(cls):
        ...
        cls.__instance = None
        cls._has_rpc = False
# REMOVED_UNUSED_CODE:         cls._rpc = None

# REMOVED_UNUSED_CODE:     def send_msg(self, msg: RPCSendMsg) -> None:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Publish the message to the message stream
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if ApiServer._message_stream:
# REMOVED_UNUSED_CODE:             ApiServer._message_stream.publish(msg)
