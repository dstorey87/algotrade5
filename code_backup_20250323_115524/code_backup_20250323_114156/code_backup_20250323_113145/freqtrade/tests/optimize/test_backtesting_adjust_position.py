...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         lambda x, *args, **kwargs: round(x, 8),
    )
...
def test_backtest_position_adjustment_detailed(default_conf, fee, mocker, leverage) -> None:
    ...
    backtesting = Backtesting(default_conf)
# REMOVED_UNUSED_CODE:     backtesting._can_short = True
    backtesting._set_strategy(backtesting.strategylist[0])
    pair = "XRP/USDT:USDT"
    row_enter = [
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=None)
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=(100, "PartIncrease"))
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=-500)
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=(-100, "partDecrease"))
    trade = backtesting._get_adjust_trade_entry_for_candle(trade, row_exit, current_time)
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=-99)
    trade = backtesting._get_adjust_trade_entry_for_candle(trade, row_exit, current_time)
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.adjust_trade_position = MagicMock(return_value=-trade.stake_amount)
    trade = backtesting._get_adjust_trade_entry_for_candle(trade, row_exit, current_time)
