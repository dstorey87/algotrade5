...
class DummyCls(Telegram):
    ...
    @authorized_only
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     async def dummy_handler(self, *args, **kwargs) -> None:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         Fake method that only change the state of the object
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         self.state["called"] = True

    @authorized_only
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     async def dummy_exception(self, *args, **kwargs) -> None:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         Fake method that throw an exception
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         raise Exception("test")
...
# REMOVED_UNUSED_CODE:     app_mock.updater.running = False
...
async def test_telegram_status(default_conf, update, mocker) -> None:
    ...
    context = MagicMock()
    # /status table
# REMOVED_UNUSED_CODE:     context.args = ["table"]
...
# REMOVED_UNUSED_CODE:     trade.orders[0].average = 0
    trade.orders.append(
        Order(
            order_id="5412vbb",
            ft_order_side="buy",
...
async def test_telegram_status_closed_trade(default_conf, update, mocker, fee) -> None:
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = [str(trade.id)]
    await telegram._status(update=update, context=context)
    assert msg_mock.call_count == 1
...
async def test_order_handle(default_conf, update, ticker, fee, mocker) -> None:
    ...
    msg_mock.reset_mock()
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["2"]
...
async def test_status_handle(default_conf, update, ticker, fee, mocker) -> None:
    ...
    msg_mock.reset_mock()
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["2", "3"]
...
# REMOVED_UNUSED_CODE:     context.args = ["2"]
    ...
    # Reset msg_mock
    msg_mock.reset_mock()
# REMOVED_UNUSED_CODE:     context.args = []
    await telegram._daily(update=update, context=context)
    assert msg_mock.call_count == 1
    ...
    # /daily 1
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["1"]
    await telegram._daily(update=update, context=context)
    assert "  6.83 USDT" in msg_mock.call_args_list[0][0][0]
    assert "  7.51 USD" in msg_mock.call_args_list[0][0][0]
    assert "(2)" in msg_mock.call_args_list[0][0][0]
...
# REMOVED_UNUSED_CODE:     context.args = ["-2"]
    ...
    # /daily today
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["today"]
    await telegram._daily(update=update, context=context)
    assert "Daily Profit over the last 7 days</b>:" in msg_mock.call_args_list[0][0][0]
...
# REMOVED_UNUSED_CODE:     context.args = []
    ...
    # /weekly -3
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["-3"]
    await telegram._weekly(update=update, context=context)
    assert msg_mock.call_count == 1
    assert "must be an integer greater than 0" in msg_mock.call_args_list[0][0][0]
    ...
    # /weekly this week
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["this week"]
    await telegram._weekly(update=update, context=context)
    assert (
        "Weekly Profit over the last 8 weeks (starting from Monday)</b>:"
        in msg_mock.call_args_list[0][0][0]
...
# REMOVED_UNUSED_CODE:     context.args = []
    ...
    # /monthly 12
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["12"]
    await telegram._monthly(update=update, context=context)
    assert msg_mock.call_count == 1
...
# REMOVED_UNUSED_CODE:     context.args = ["-3"]
    ...
    # /monthly february
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["february"]
    await telegram._monthly(update=update, context=context)
    assert "Monthly Profit over the last 6 months</b>:" in msg_mock.call_args_list[0][0][0]
...
# REMOVED_UNUSED_CODE:     context.args = ["aaa"]
...
# REMOVED_UNUSED_CODE:     trade.close_date = datetime.now(timezone.utc)
    trade.is_open = False
    Trade.commit()
...
async def test_telegram_balance_handle(default_conf, update, mocker, rpc_balance, tickers) -> None:
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["full"]
...
async def test_forceexit_all_handle(default_conf, update, ticker, fee, mocker) -> None:
    ...
    # /forceexit all
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["all"]
    await telegram._force_exit(update=update, context=context)
...
# REMOVED_UNUSED_CODE:     context.args = ["1"]
    ...
    # /forceexit 123456
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["123456"]
    await telegram._force_exit(update=update, context=context)
    assert msg_mock.call_count == 1
...
# REMOVED_UNUSED_CODE:     update.callback_query.data = keyboard[1][0].callback_data
...
async def test_force_enter_handle(default_conf, update, mocker) -> None:
    ...
    # /forcelong ETH/BTC
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["ETH/BTC"]
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["ETH/BTC", "0.055"]
    await telegram._force_enter(update=update, context=context, order_side=SignalDirection.LONG)
...
# REMOVED_UNUSED_CODE:     context.args = []
    ...
    update = MagicMock()
    update.callback_query = AsyncMock()
# REMOVED_UNUSED_CODE:     update.callback_query.data = "force_enter__XRP/USDT_||_long"
    await telegram._force_enter_inline(update, None)
    assert fbuy_mock.call_count == 1

    fbuy_mock.reset_mock()
    update.callback_query = AsyncMock()
# REMOVED_UNUSED_CODE:     update.callback_query.data = "force_enter__cancel"
    await telegram._force_enter_inline(update, None)
    assert fbuy_mock.call_count == 0
    query = update.callback_query
    assert query.edit_message_text.call_count == 1
...
# REMOVED_UNUSED_CODE:     context.args = ["XRP/USDT"]
    await telegram._enter_tag_performance(update=update, context=context)
    assert msg_mock.call_count == 2
...
async def test_telegram_lock_handle(default_conf, update, ticker, fee, mocker) -> None:
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["XRP/BTC"]
    msg_mock.reset_mock()
...
async def test_whitelist_static(default_conf, update, mocker) -> None:
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["sorted"]
    msg_mock.reset_mock()
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["baseonly"]
    msg_mock.reset_mock()
    await telegram._whitelist(update=update, context=context)
    assert (
        "Using whitelist `['StaticPairList']` with 4 pairs\n"
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["baseonly", "sorted"]
    msg_mock.reset_mock()
    await telegram._whitelist(update=update, context=context)
    assert (
        "Using whitelist `['StaticPairList']` with 4 pairs\n"
...
# REMOVED_UNUSED_CODE:     context.args = ["ETH/BTC"]
    ...
    msg_mock.reset_mock()
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["XRP/.*"]
    await telegram._blacklist(update=update, context=context)
    assert msg_mock.call_count == 1
    ...
    msg_mock.reset_mock()
# REMOVED_UNUSED_CODE:     context.args = ["DOGE/BTC"]
...
# REMOVED_UNUSED_CODE:     context.args = ["hello"]
    await telegram._trades(update=update, context=context)
    assert "<b>0 recent trades</b>:" in msg_mock.call_args_list[0][0][0]
    assert "<pre>" not in msg_mock.call_args_list[0][0][0]
    msg_mock.reset_mock()
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = [5]
    await telegram._trades(update=update, context=context)
    assert msg_mock.call_count == 1
...
# REMOVED_UNUSED_CODE:     context.args = [5]
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = [6]
    await telegram._cancel_open_order(update=update, context=context)
    assert msg_mock.call_count == 1
...
async def test_version_handle(default_conf, update, mocker) -> None:
    ...
    msg_mock.reset_mock()
# REMOVED_UNUSED_CODE:     freqtradebot.strategy.version = lambda: "1.1.1"
...
# REMOVED_UNUSED_CODE:         telegram._rpc._fiat_converter.convert_amount = lambda a, b, c: -24.812
        telegram.send_msg(
            {
                "type": RPCMessageType.EXIT,
                "trade_id": 1,
...
async def test_change_market_direction(default_conf, mocker, update) -> None:
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["long"]
    ...
    context = MagicMock()
# REMOVED_UNUSED_CODE:     context.args = ["invalid"]
    await telegram._changemarketdir(update, context)
    assert telegram._rpc._freqtrade.strategy.market_direction == MarketDirection.LONG
...
# REMOVED_UNUSED_CODE:     context.args = ["1"]
    ...
    Trade.commit()
# REMOVED_UNUSED_CODE:     context.args = [f"{trade1.id}"]
    await telegram._list_custom_data(update=update, context=context)
    assert msg_mock.call_count == 3
