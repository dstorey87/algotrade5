...
def test_trade_custom_data(fee, use_db):
    ...
    if not use_db:
# REMOVED_UNUSED_CODE:         trade1.id = 1
...
# REMOVED_UNUSED_CODE:     def custom_exit(pair, trade, **kwargs):
# REMOVED_UNUSED_CODE:         if pair == "ADA/USDT":
# REMOVED_UNUSED_CODE:             custom_val = trade.get_custom_data("test_str")
# REMOVED_UNUSED_CODE:             custom_val_i = trade.get_custom_data("test_int")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             return f"{custom_val}_{custom_val_i}"
...
# REMOVED_UNUSED_CODE:     def custom_exit(pair, trade, **kwargs):
# REMOVED_UNUSED_CODE:         custom_val = trade.get_custom_data("test_str")
# REMOVED_UNUSED_CODE:         custom_val_i = trade.get_custom_data("test_int", 0)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if pair == pair_exp:
# REMOVED_UNUSED_CODE:             trade.set_custom_data("test_str", "test_value")
# REMOVED_UNUSED_CODE:             trade.set_custom_data("test_int", custom_val_i + 1)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if custom_val_i >= 2:
# REMOVED_UNUSED_CODE:             return f"{custom_val}_{custom_val_i}"
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     def fun(dataframe, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         dataframe.loc[dataframe.index == 50, "enter_long"] = 1
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         return dataframe

# REMOVED_UNUSED_CODE:     backtesting.strategy.advise_entry = fun
# REMOVED_UNUSED_CODE:     backtesting.strategy.leverage = MagicMock(return_value=1)
