...
def test_fetch_my_trades_gate(mocker, default_conf, takerormaker, rate, cost):
    ...
    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     api_mock.fetch_my_trades = MagicMock(
# REMOVED_UNUSED_CODE:         return_value=[
# REMOVED_UNUSED_CODE:             {
# REMOVED_UNUSED_CODE:                 "fee": {"cost": None},
# REMOVED_UNUSED_CODE:                 "price": 3108.65,
# REMOVED_UNUSED_CODE:                 "cost": 0.310865,
# REMOVED_UNUSED_CODE:                 "order": "22255",
# REMOVED_UNUSED_CODE:                 "takerOrMaker": takerormaker,
# REMOVED_UNUSED_CODE:                 "amount": 1,  # 1 contract
# REMOVED_UNUSED_CODE:             }
# REMOVED_UNUSED_CODE:         ]
# REMOVED_UNUSED_CODE:     )
    exchange = get_patched_exchange(mocker, default_conf, api_mock=api_mock, exchange="gate")
# REMOVED_UNUSED_CODE:     exchange._trading_fees = tick
