...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     async def _handle_whitelist(self, name, msgtype, data):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         self.logger.info(data)

# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     async def _handle_analyzed_df(self, name, msgtype, data):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         key, la, df = data["key"], data["la"], data["df"]
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         if not df.empty:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             columns = ", ".join([str(column) for column in df.columns])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info(key)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info(f"Last analyzed datetime: {la}")
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info(f"Latest candle datetime: {df.iloc[-1]['date']}")
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info(f"DataFrame length: {len(df)}")
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info(f"DataFrame columns: {columns}")
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             self.logger.info("Empty DataFrame")

# REMOVED_UNUSED_CODE:     async def _handle_default(self, name, msgtype, data):
# REMOVED_UNUSED_CODE:         self.logger.info("Unknown message of type {msgtype} received...")
# REMOVED_UNUSED_CODE:         self.logger.info(data)
