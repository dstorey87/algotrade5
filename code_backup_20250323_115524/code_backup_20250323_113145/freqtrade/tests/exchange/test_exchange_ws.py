...
# REMOVED_UNUSED_CODE: from ccxt import NotSupported
...
def test_exchangews_cleanup_error(mocker, caplog):
    config = MagicMock()
    ccxt_object = MagicMock()
# REMOVED_UNUSED_CODE:     ccxt_object.close = AsyncMock(side_effect=Exception("Test"))
    mocker.patch("freqtrade.exchange.exchange_ws.ExchangeWS._start_forever", MagicMock())
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     async def sleeper(*args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         # pass
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         await asyncio.sleep(0.12)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         return MagicMock()

# REMOVED_UNUSED_CODE:     ccxt_object.un_watch_ohlcv_for_symbols = AsyncMock(side_effect=NotSupported)

    ccxt_object.watch_ohlcv = AsyncMock(side_effect=sleeper)
# REMOVED_UNUSED_CODE:     ccxt_object.close = AsyncMock()
    ...
    try:
        ...
        # Cleanup happened.
# REMOVED_UNUSED_CODE:         ccxt_object.un_watch_ohlcv_for_symbols = AsyncMock(side_effect=ValueError)
        exchange_ws.schedule_ohlcv("ETH/BTC", "1m", CandleType.SPOT)
        assert exchange_ws._klines_watching == {
            ("ETH/BTC", "1m", CandleType.SPOT),
        }
...
async def test_exchangews_get_ohlcv(mocker, caplog):
    config = MagicMock()
    ccxt_object = MagicMock()
# REMOVED_UNUSED_CODE:     ccxt_object.ohlcvs = {
# REMOVED_UNUSED_CODE:         "ETH/USDT": {
# REMOVED_UNUSED_CODE:             "1m": [
# REMOVED_UNUSED_CODE:                 [1635840000000, 100, 200, 300, 400, 500],
# REMOVED_UNUSED_CODE:                 [1635840060000, 101, 201, 301, 401, 501],
# REMOVED_UNUSED_CODE:                 [1635840120000, 102, 202, 302, 402, 502],
# REMOVED_UNUSED_CODE:             ],
# REMOVED_UNUSED_CODE:             "5m": [
# REMOVED_UNUSED_CODE:                 [1635840000000, 100, 200, 300, 400, 500],
# REMOVED_UNUSED_CODE:                 [1635840300000, 105, 201, 301, 401, 501],
# REMOVED_UNUSED_CODE:                 [1635840600000, 102, 202, 302, 402, 502],
# REMOVED_UNUSED_CODE:             ],
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:     }
    mocker.patch("freqtrade.exchange.exchange_ws.ExchangeWS._start_forever", MagicMock())
