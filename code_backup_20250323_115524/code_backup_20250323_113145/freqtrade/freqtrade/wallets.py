...
# REMOVED_UNUSED_CODE: from typing import Literal, NamedTuple

# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.constants import UNLIMITED_STAKE_AMOUNT, Config, IntOrInf
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.enums import RunMode, TradingMode
...
# REMOVED_UNUSED_CODE: from freqtrade.misc import safe_value_fallback
...
# REMOVED_UNUSED_CODE: class Wallet(NamedTuple):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     currency: str
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     free: float = 0
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     used: float = 0
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     total: float = 0


# REMOVED_UNUSED_CODE: class PositionWallet(NamedTuple):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     symbol: str
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     position: float = 0
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     leverage: float | None = 0  # Don't use this - it's not guaranteed to be set
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     collateral: float = 0
