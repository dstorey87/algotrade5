...
class GPUMonitor:
        ...
        try:
            ...
            # Fallback to torch.cuda
                ...
                metrics.update({
                    ...
                    'memory_total': cuda.get_device_properties(self.gpu_index).total_memory,
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            metrics['memory_used_percent'] < self.memory_threshold and
            metrics['temperature'] < self.temp_threshold and
            metrics['utilization'] < self.util_threshold
        )
