...
class TradeJournal:
    ...
    def update_trade(self, trade_id: str, exit_data: Dict) -> bool:
        ...
        try:
            with sqlite3.connect('data/journal.db') as conn:
                ...
                profit_ratio = (exit_data['exit_price'] - trade['entry_price']) / trade['entry_price']
    ...
    def calculate_growth_progress(self) -> float:
        ...
        try:
            current_capital = self.get_current_capital()
            return (current_capital - self.initial_capital) / (self.target_capital - self.initial_capital)
