        ...
        if len(dataframe) > 0:
            ...
            for pattern_name in self.active_patterns:
                ...
                if score_col in last_candle and conf_col in last_candle:
                    if (
                        last_candle[score_col] < -0.6
                        and last_candle[conf_col] > self.min_pattern_confidence
                    ):
    ...
    def custom_stake_amount(
        ...
        **kwargs,
        ...
        return self.risk_manager.calculate_position_size(
            pair=pair, current_rate=current_rate, max_stake=max_stake
        )
    ...
    def _optimize_strategy(self) -> None:
        ...
        try:
            ...
            optimized = self.strategy_optimizer.optimize_strategy(
                self.strategy_id, strategy_data
            )
            ...
            if optimized:
                ...
                self.minimal_roi = {"0": optimized["risk_params"]["take_profit"]}
