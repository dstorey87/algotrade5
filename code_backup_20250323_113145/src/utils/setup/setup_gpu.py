...
# REMOVED_UNUSED_CODE:             max_memory = int(total_memory * 0.9)
...
# REMOVED_UNUSED_CODE:         torch.backends.cudnn.benchmark = True
# REMOVED_UNUSED_CODE:         torch.backends.cuda.matmul.allow_tf32 = True
