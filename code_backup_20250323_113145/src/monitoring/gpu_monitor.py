...
# REMOVED_UNUSED_CODE: from src.core.error_manager import ErrorSeverity, get_error_manager
...
# REMOVED_UNUSED_CODE:     GPUtil = None
...
# REMOVED_UNUSED_CODE:         self.has_gpu = torch is not None and torch.cuda.is_available()
# REMOVED_UNUSED_CODE:         self.gpu_index = 0  # Primary GPU

        # Thresholds
# REMOVED_UNUSED_CODE:         self.memory_threshold = 0.90  # 90% memory usage alert
# REMOVED_UNUSED_CODE:         self.temp_threshold = 80.0  # 80°C temperature alert
# REMOVED_UNUSED_CODE:         self.util_threshold = 0.95  # 95% utilization alert

        # Last recorded metrics
# REMOVED_UNUSED_CODE:         self.last_metrics: Dict = {}
...
# REMOVED_UNUSED_CODE:     def get_metrics(self) -> Dict:
# REMOVED_UNUSED_CODE:         """Get current GPU metrics"""
# REMOVED_UNUSED_CODE:         metrics = {
# REMOVED_UNUSED_CODE:             "timestamp": datetime.now().isoformat(),
# REMOVED_UNUSED_CODE:             "gpu_available": self.has_gpu,
# REMOVED_UNUSED_CODE:             "memory_used_percent": 0.0,
# REMOVED_UNUSED_CODE:             "temperature": 0.0,
# REMOVED_UNUSED_CODE:             "utilization": 0.0,
# REMOVED_UNUSED_CODE:             "memory_total": 0,
# REMOVED_UNUSED_CODE:             "memory_used": 0,
# REMOVED_UNUSED_CODE:             "gpu_name": "CPU Only",
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if not self.has_gpu:
...
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         try:
# REMOVED_UNUSED_CODE:             # Get GPU metrics using GPUtil if available
# REMOVED_UNUSED_CODE:             if GPUtil:
# REMOVED_UNUSED_CODE:                 gpu = GPUtil.getGPUs()[self.gpu_index]
# REMOVED_UNUSED_CODE:                 metrics.update(
# REMOVED_UNUSED_CODE:                     {
# REMOVED_UNUSED_CODE:                         "memory_used_percent": gpu.memoryUtil,
# REMOVED_UNUSED_CODE:                         "temperature": gpu.temperature,
# REMOVED_UNUSED_CODE:                         "utilization": gpu.load,
# REMOVED_UNUSED_CODE:                         "memory_total": gpu.memoryTotal,
# REMOVED_UNUSED_CODE:                         "memory_used": gpu.memoryUsed,
# REMOVED_UNUSED_CODE:                         "gpu_name": gpu.name,
# REMOVED_UNUSED_CODE:                     }
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:             # Fallback to torch.cuda
# REMOVED_UNUSED_CODE:             elif cuda:
# REMOVED_UNUSED_CODE:                 metrics.update(
# REMOVED_UNUSED_CODE:                     {
# REMOVED_UNUSED_CODE:                         "memory_used_percent": cuda.memory_allocated()
# REMOVED_UNUSED_CODE:                         / cuda.get_device_properties(self.gpu_index).total_memory,
# REMOVED_UNUSED_CODE:                         "memory_total": cuda.get_device_properties(
# REMOVED_UNUSED_CODE:                             self.gpu_index
# REMOVED_UNUSED_CODE:                         ).total_memory,
# REMOVED_UNUSED_CODE:                         "memory_used": cuda.memory_allocated(),
# REMOVED_UNUSED_CODE:                         "gpu_name": cuda.get_device_name(self.gpu_index),
# REMOVED_UNUSED_CODE:                     }
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             self.last_metrics = metrics
# REMOVED_UNUSED_CODE:             return metrics
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         except Exception as e:
# REMOVED_UNUSED_CODE:             self.error_manager.log_error(
# REMOVED_UNUSED_CODE:                 f"Failed to get GPU metrics: {e}", ErrorSeverity.LOW.value, "GPU"
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:             return self.last_metrics or metrics
