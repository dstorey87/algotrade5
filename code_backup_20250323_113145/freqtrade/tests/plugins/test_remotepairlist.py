...
# REMOVED_UNUSED_CODE:     mock_response.headers = {"content-type": "text/html"}
...
# REMOVED_UNUSED_CODE:     remote_pairlist._last_pairlist = ["BTC/USDT", "ETH/USDT", "LTC/USDT"]
# REMOVED_UNUSED_CODE:     remote_pairlist._init_done = True
...
# REMOVED_UNUSED_CODE:     mock_response.headers = {"content-type": "application/json"}
