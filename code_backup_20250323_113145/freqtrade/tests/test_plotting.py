...
# REMOVED_UNUSED_CODE: def fig_generating_mock(fig, *args, **kwargs):
# REMOVED_UNUSED_CODE:     """Return Fig - used to mock add_indicators and plot_trades"""
# REMOVED_UNUSED_CODE:     return fig
