...
# REMOVED_UNUSED_CODE: TRADE_SIDES = ("long", "short")
...
# REMOVED_UNUSED_CODE:         config.option.markexpr = "not longrun"
...
# REMOVED_UNUSED_CODE:     def _split_scope(self, nodeid):
# REMOVED_UNUSED_CODE:         if "exchange_online" in nodeid:
# REMOVED_UNUSED_CODE:             try:
# REMOVED_UNUSED_CODE:                 # Extract exchange ID from nodeid
# REMOVED_UNUSED_CODE:                 exchange_id = nodeid.split("[")[1].split("-")[0].rstrip("]")
# REMOVED_UNUSED_CODE:                 return exchange_id
# REMOVED_UNUSED_CODE:             except Exception as e:
# REMOVED_UNUSED_CODE:                 print(e)
# REMOVED_UNUSED_CODE:                 pass
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         return nodeid
...
# REMOVED_UNUSED_CODE: def log_has(line, logs):
# REMOVED_UNUSED_CODE:     """Check if line is found on some caplog's message."""
# REMOVED_UNUSED_CODE:     return any(line == message for message in logs.messages)


# REMOVED_UNUSED_CODE: def log_has_when(line, logs, when):
# REMOVED_UNUSED_CODE:     """Check if line is found in caplog's messages during a specified stage"""
# REMOVED_UNUSED_CODE:     return any(line == message.message for message in logs.get_records(when))


# REMOVED_UNUSED_CODE: def log_has_re(line, logs):
# REMOVED_UNUSED_CODE:     """Check if line matches some caplog's message."""
# REMOVED_UNUSED_CODE:     return any(re.match(line, message) for message in logs.messages)


# REMOVED_UNUSED_CODE: def num_log_has(line, logs):
# REMOVED_UNUSED_CODE:     """Check how many times line is found in caplog's messages."""
# REMOVED_UNUSED_CODE:     return sum(line == message for message in logs.messages)


# REMOVED_UNUSED_CODE: def num_log_has_re(line, logs):
# REMOVED_UNUSED_CODE:     """Check how many times line matches caplog's messages."""
# REMOVED_UNUSED_CODE:     return sum(bool(re.match(line, message)) for message in logs.messages)


# REMOVED_UNUSED_CODE: def get_args(args):
# REMOVED_UNUSED_CODE:     return Arguments(args).get_parsed_arg()


# REMOVED_UNUSED_CODE: def generate_trades_history(n_rows, start_date: datetime | None = None, days=5):
# REMOVED_UNUSED_CODE:     np.random.seed(42)
# REMOVED_UNUSED_CODE:     if not start_date:
# REMOVED_UNUSED_CODE:         start_date = datetime(2020, 1, 1, tzinfo=timezone.utc)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         # Generate random data
# REMOVED_UNUSED_CODE:     end_date = start_date + timedelta(days=days)
# REMOVED_UNUSED_CODE:     _start_timestamp = start_date.timestamp()
# REMOVED_UNUSED_CODE:     _end_timestamp = pd.to_datetime(end_date).timestamp()
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     random_timestamps_in_seconds = np.random.uniform(_start_timestamp, _end_timestamp, n_rows)
# REMOVED_UNUSED_CODE:     timestamp = pd.to_datetime(random_timestamps_in_seconds, unit="s")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade_id = [
# REMOVED_UNUSED_CODE:         f"a{np.random.randint(1e6, 1e7 - 1)}cd{np.random.randint(100, 999)}" for _ in range(n_rows)
# REMOVED_UNUSED_CODE:     ]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     side = np.random.choice(["buy", "sell"], n_rows)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Initial price and subsequent changes
# REMOVED_UNUSED_CODE:     initial_price = 0.019626
# REMOVED_UNUSED_CODE:     price_changes = np.random.normal(0, initial_price * 0.05, n_rows)
# REMOVED_UNUSED_CODE:     price = np.cumsum(np.concatenate(([initial_price], price_changes)))[:n_rows]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     amount = np.random.uniform(0.011, 20, n_rows)
# REMOVED_UNUSED_CODE:     cost = price * amount
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Create DataFrame
# REMOVED_UNUSED_CODE:     df = pd.DataFrame(
# REMOVED_UNUSED_CODE:         {
# REMOVED_UNUSED_CODE:             "timestamp": timestamp,
# REMOVED_UNUSED_CODE:             "id": trade_id,
# REMOVED_UNUSED_CODE:             "type": None,
# REMOVED_UNUSED_CODE:             "side": side,
# REMOVED_UNUSED_CODE:             "price": price,
# REMOVED_UNUSED_CODE:             "amount": amount,
# REMOVED_UNUSED_CODE:             "cost": cost,
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     df["date"] = pd.to_datetime(df["timestamp"], unit="ms", utc=True)
# REMOVED_UNUSED_CODE:     df = df.sort_values("timestamp").reset_index(drop=True)
# REMOVED_UNUSED_CODE:     assert list(df.columns) == constants.DEFAULT_TRADES_COLUMNS + ["date"]
...
# REMOVED_UNUSED_CODE: def get_mock_coro(return_value=None, side_effect=None):
# REMOVED_UNUSED_CODE:     async def mock_coro(*args, **kwargs):
# REMOVED_UNUSED_CODE:         if side_effect:
# REMOVED_UNUSED_CODE:             if isinstance(side_effect, list):
# REMOVED_UNUSED_CODE:                 effect = side_effect.pop(0)
# REMOVED_UNUSED_CODE:             else:
# REMOVED_UNUSED_CODE:                 effect = side_effect
# REMOVED_UNUSED_CODE:             if isinstance(effect, Exception):
# REMOVED_UNUSED_CODE:                 raise effect
# REMOVED_UNUSED_CODE:             if callable(effect):
# REMOVED_UNUSED_CODE:                 return effect(*args, **kwargs)
# REMOVED_UNUSED_CODE:             return effect
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             return return_value
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     return Mock(wraps=mock_coro)


# REMOVED_UNUSED_CODE: def patched_configuration_load_config_file(mocker, config) -> None:
# REMOVED_UNUSED_CODE:     mocker.patch(
# REMOVED_UNUSED_CODE:         "freqtrade.configuration.load_config.load_config_file", lambda *args, **kwargs: config
# REMOVED_UNUSED_CODE:     )
...
# REMOVED_UNUSED_CODE: def get_patched_exchange(
# REMOVED_UNUSED_CODE:     mocker, config, api_mock=None, exchange="binance", mock_markets=True, mock_supported_modes=True
# REMOVED_UNUSED_CODE: ) -> Exchange:
# REMOVED_UNUSED_CODE:     patch_exchange(mocker, api_mock, exchange, mock_markets, mock_supported_modes)
# REMOVED_UNUSED_CODE:     config["exchange"]["name"] = exchange
# REMOVED_UNUSED_CODE:     try:
# REMOVED_UNUSED_CODE:         exchange = ExchangeResolver.load_exchange(config, load_leverage_tiers=True)
# REMOVED_UNUSED_CODE:     except ImportError:
# REMOVED_UNUSED_CODE:         exchange = Exchange(config)
# REMOVED_UNUSED_CODE:     return exchange


# REMOVED_UNUSED_CODE: def patch_wallet(mocker, free=999.9) -> None:
# REMOVED_UNUSED_CODE:     mocker.patch("freqtrade.wallets.Wallets.get_free", MagicMock(return_value=free))
...
# REMOVED_UNUSED_CODE: def patch_edge(mocker) -> None:
# REMOVED_UNUSED_CODE:     # "ETH/BTC",
# REMOVED_UNUSED_CODE:     # "LTC/BTC",
# REMOVED_UNUSED_CODE:     # "XRP/BTC",
# REMOVED_UNUSED_CODE:     # "NEO/BTC"
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     mocker.patch(
# REMOVED_UNUSED_CODE:         "freqtrade.edge.Edge._cached_pairs",
# REMOVED_UNUSED_CODE:         mocker.PropertyMock(
# REMOVED_UNUSED_CODE:             return_value={
# REMOVED_UNUSED_CODE:                 "NEO/BTC": PairInfo(-0.20, 0.66, 3.71, 0.50, 1.71, 10, 25),
# REMOVED_UNUSED_CODE:                 "LTC/BTC": PairInfo(-0.21, 0.66, 3.71, 0.50, 1.71, 11, 20),
# REMOVED_UNUSED_CODE:             }
# REMOVED_UNUSED_CODE:         ),
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     mocker.patch("freqtrade.edge.Edge.calculate", MagicMock(return_value=True))
...
# REMOVED_UNUSED_CODE: def get_patched_freqtradebot(mocker, config) -> FreqtradeBot:
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     This function patches _init_modules() to not call dependencies
# REMOVED_UNUSED_CODE:     :param mocker: a Mocker object to apply patches
# REMOVED_UNUSED_CODE:     :param config: Config to pass to the bot
# REMOVED_UNUSED_CODE:     :return: FreqtradeBot
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     patch_freqtradebot(mocker, config)
# REMOVED_UNUSED_CODE:     return FreqtradeBot(config)


# REMOVED_UNUSED_CODE: def get_patched_worker(mocker, config) -> Worker:
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     This function patches _init_modules() to not call dependencies
# REMOVED_UNUSED_CODE:     :param mocker: a Mocker object to apply patches
# REMOVED_UNUSED_CODE:     :param config: Config to pass to the bot
# REMOVED_UNUSED_CODE:     :return: Worker
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     patch_freqtradebot(mocker, config)
# REMOVED_UNUSED_CODE:     return Worker(args=None, config=config)


# REMOVED_UNUSED_CODE: def patch_get_signal(
# REMOVED_UNUSED_CODE:     freqtrade: FreqtradeBot,
# REMOVED_UNUSED_CODE:     enter_long=True,
# REMOVED_UNUSED_CODE:     exit_long=False,
# REMOVED_UNUSED_CODE:     enter_short=False,
# REMOVED_UNUSED_CODE:     exit_short=False,
# REMOVED_UNUSED_CODE:     enter_tag: str | None = None,
# REMOVED_UNUSED_CODE:     exit_tag: str | None = None,
# REMOVED_UNUSED_CODE: ) -> None:
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     :param mocker: mocker to patch IStrategy class
# REMOVED_UNUSED_CODE:     :return: None
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # returns (Signal-direction, signaname)
# REMOVED_UNUSED_CODE:     def patched_get_entry_signal(*args, **kwargs):
# REMOVED_UNUSED_CODE:         direction = None
# REMOVED_UNUSED_CODE:         if enter_long and not any([exit_long, enter_short]):
# REMOVED_UNUSED_CODE:             direction = SignalDirection.LONG
# REMOVED_UNUSED_CODE:         if enter_short and not any([exit_short, enter_long]):
# REMOVED_UNUSED_CODE:             direction = SignalDirection.SHORT
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         return direction, enter_tag
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     freqtrade.strategy.get_entry_signal = patched_get_entry_signal
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     def patched_get_exit_signal(pair, timeframe, dataframe, is_short):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         if is_short:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             return enter_short, exit_short, exit_tag
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             return enter_long, exit_long, exit_tag
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # returns (enter, exit)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     freqtrade.strategy.get_exit_signal = patched_get_exit_signal
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     freqtrade.exchange.refresh_latest_ohlcv = lambda p: None


# REMOVED_UNUSED_CODE: def create_mock_trades(fee, is_short: bool | None = False, use_db: bool = True):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Create some fake trades ...
# REMOVED_UNUSED_CODE:     :param is_short: Optional bool, None creates a mix of long and short trades.
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     def add_trade(trade):
# REMOVED_UNUSED_CODE:         if use_db:
# REMOVED_UNUSED_CODE:             Trade.session.add(trade)
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             LocalTrade.add_bt_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     is_short1 = is_short if is_short is not None else True
# REMOVED_UNUSED_CODE:     is_short2 = is_short if is_short is not None else False
# REMOVED_UNUSED_CODE:     # Simulate dry_run entries
# REMOVED_UNUSED_CODE:     trade = mock_trade_1(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_2(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_3(fee, is_short2)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_4(fee, is_short2)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_5(fee, is_short2)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_6(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     if use_db:
...
# REMOVED_UNUSED_CODE: def create_mock_trades_with_leverage(fee, use_db: bool = True):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Create some fake trades ...
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     if use_db:
# REMOVED_UNUSED_CODE:         Trade.session.rollback()
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     def add_trade(trade):
# REMOVED_UNUSED_CODE:         if use_db:
# REMOVED_UNUSED_CODE:             Trade.session.add(trade)
...
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Simulate dry_run entries
# REMOVED_UNUSED_CODE:     trade = mock_trade_1(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_2(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_3(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_4(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_5(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_6(fee, False)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = short_trade(fee)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = leverage_trade(fee)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     if use_db:
# REMOVED_UNUSED_CODE:         Trade.session.flush()


# REMOVED_UNUSED_CODE: def create_mock_trades_usdt(fee, is_short: bool | None = False, use_db: bool = True):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Create some fake trades ...
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Simulate dry_run entries
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_1(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_2(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_3(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_4(fee, is_short2)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_5(fee, is_short2)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_6(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trade = mock_trade_usdt_7(fee, is_short1)
# REMOVED_UNUSED_CODE:     add_trade(trade)
# REMOVED_UNUSED_CODE:     if use_db:
# REMOVED_UNUSED_CODE:         Trade.commit()
...
# REMOVED_UNUSED_CODE: def is_arm() -> bool:
# REMOVED_UNUSED_CODE:     machine = platform.machine()
# REMOVED_UNUSED_CODE:     return "arm" in machine or "aarch64" in machine
...
# REMOVED_UNUSED_CODE:     trade.orders = [
# REMOVED_UNUSED_CODE:         Order(
# REMOVED_UNUSED_CODE:             ft_order_side="buy",
# REMOVED_UNUSED_CODE:             ft_pair=trade.pair,
# REMOVED_UNUSED_CODE:             ft_is_open=True,
# REMOVED_UNUSED_CODE:             ft_amount=trade.amount,
# REMOVED_UNUSED_CODE:             ft_price=trade.open_rate,
# REMOVED_UNUSED_CODE:             order_id="123456789",
# REMOVED_UNUSED_CODE:             status="closed",
# REMOVED_UNUSED_CODE:             symbol=trade.pair,
# REMOVED_UNUSED_CODE:             order_type="market",
# REMOVED_UNUSED_CODE:             side="buy",
# REMOVED_UNUSED_CODE:             price=trade.open_rate,
# REMOVED_UNUSED_CODE:             average=trade.open_rate,
# REMOVED_UNUSED_CODE:             filled=trade.amount,
# REMOVED_UNUSED_CODE:             remaining=0,
# REMOVED_UNUSED_CODE:             cost=trade.open_rate * trade.amount,
# REMOVED_UNUSED_CODE:             order_date=trade.open_date,
# REMOVED_UNUSED_CODE:             order_filled_date=trade.open_date,
# REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE:     ]
    return trade
...
# REMOVED_UNUSED_CODE:             ft_order_side="buy",
# REMOVED_UNUSED_CODE:             ft_pair=trade.pair,
# REMOVED_UNUSED_CODE:             ft_is_open=False,
# REMOVED_UNUSED_CODE:             ft_amount=trade.amount,
# REMOVED_UNUSED_CODE:             ft_price=trade.open_rate,
# REMOVED_UNUSED_CODE:             order_id="123456789",
# REMOVED_UNUSED_CODE:             status="closed",
...
# REMOVED_UNUSED_CODE:         ),
# REMOVED_UNUSED_CODE:         Order(
# REMOVED_UNUSED_CODE:             ft_order_side="exit",
# REMOVED_UNUSED_CODE:             ft_pair=trade.pair,
# REMOVED_UNUSED_CODE:             ft_is_open=True,
# REMOVED_UNUSED_CODE:             ft_amount=trade.amount,
# REMOVED_UNUSED_CODE:             ft_price=trade.open_rate,
# REMOVED_UNUSED_CODE:             order_id="123456789_exit",
# REMOVED_UNUSED_CODE:             status="open",
# REMOVED_UNUSED_CODE:             symbol=trade.pair,
# REMOVED_UNUSED_CODE:             order_type="limit",
# REMOVED_UNUSED_CODE:             side="sell",
# REMOVED_UNUSED_CODE:             price=trade.open_rate,
# REMOVED_UNUSED_CODE:             average=trade.open_rate,
# REMOVED_UNUSED_CODE:             filled=trade.amount,
# REMOVED_UNUSED_CODE:             remaining=0,
