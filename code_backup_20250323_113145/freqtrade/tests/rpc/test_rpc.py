...
# REMOVED_UNUSED_CODE: from freqtrade.exceptions import ExchangeError, InvalidOrderException, TemporaryError
# REMOVED_UNUSED_CODE: from freqtrade.persistence import Order, Trade
from freqtrade.persistence.key_value_store import set_startup_time
from freqtrade.rpc import RPC, RPCException
# REMOVED_UNUSED_CODE: from freqtrade.rpc.fiat_convert import CryptoToFiatConverter
...
# REMOVED_UNUSED_CODE:     trade.orders[0].remaining = None
    Trade.commit()
    ...
    trade = Trade.get_open_trades()[0]
# REMOVED_UNUSED_CODE:     trade.orders[0].remaining = trade.amount
    Trade.commit()
...
# REMOVED_UNUSED_CODE:     rpc._fiat_converter = CryptoToFiatConverter({})
    result, headers, fiat_profit_sum, total_sum = rpc._rpc_status_table(
        default_conf["stake_currency"], "USD"
    )
    assert "Since" in headers
...
@pytest.mark.parametrize("is_short", [True, False])
# REMOVED_UNUSED_CODE: def test_rpc_delete_trade(mocker, default_conf, fee, markets, caplog, is_short):
# REMOVED_UNUSED_CODE:     mocker.patch("freqtrade.rpc.telegram.Telegram", MagicMock())
# REMOVED_UNUSED_CODE:     stoploss_mock = MagicMock()
# REMOVED_UNUSED_CODE:     cancel_mock = MagicMock()
# REMOVED_UNUSED_CODE:     mocker.patch.multiple(
# REMOVED_UNUSED_CODE:         EXMS,
# REMOVED_UNUSED_CODE:         markets=PropertyMock(return_value=markets),
# REMOVED_UNUSED_CODE:         cancel_order=cancel_mock,
# REMOVED_UNUSED_CODE:         cancel_stoploss_order=stoploss_mock,
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     freqtradebot = get_patched_freqtradebot(mocker, default_conf)
# REMOVED_UNUSED_CODE:     freqtradebot.strategy.order_types["stoploss_on_exchange"] = True
# REMOVED_UNUSED_CODE:     create_mock_trades(fee, is_short)
# REMOVED_UNUSED_CODE:     rpc = RPC(freqtradebot)
# REMOVED_UNUSED_CODE:     with pytest.raises(RPCException, match="invalid argument"):
# REMOVED_UNUSED_CODE:         rpc._rpc_delete("200")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     trades = Trade.session.scalars(select(Trade)).all()
# REMOVED_UNUSED_CODE:     trades[2].orders.append(
# REMOVED_UNUSED_CODE:         Order(
# REMOVED_UNUSED_CODE:             ft_order_side="stoploss",
# REMOVED_UNUSED_CODE:             ft_pair=trades[2].pair,
# REMOVED_UNUSED_CODE:             ft_is_open=True,
# REMOVED_UNUSED_CODE:             ft_amount=trades[2].amount,
# REMOVED_UNUSED_CODE:             ft_price=trades[2].stop_loss,
# REMOVED_UNUSED_CODE:             order_id="102",
# REMOVED_UNUSED_CODE:             status="open",
# REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     assert len(trades) > 2
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     res = rpc._rpc_delete("1")
# REMOVED_UNUSED_CODE:     assert isinstance(res, dict)
# REMOVED_UNUSED_CODE:     assert res["result"] == "success"
# REMOVED_UNUSED_CODE:     assert res["trade_id"] == "1"
# REMOVED_UNUSED_CODE:     assert res["cancel_order_count"] == 1
# REMOVED_UNUSED_CODE:     assert cancel_mock.call_count == 1
# REMOVED_UNUSED_CODE:     assert stoploss_mock.call_count == 0
# REMOVED_UNUSED_CODE:     cancel_mock.reset_mock()
# REMOVED_UNUSED_CODE:     stoploss_mock.reset_mock()
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     res = rpc._rpc_delete("5")
# REMOVED_UNUSED_CODE:     assert isinstance(res, dict)
# REMOVED_UNUSED_CODE:     assert stoploss_mock.call_count == 1
# REMOVED_UNUSED_CODE:     assert res["cancel_order_count"] == 1
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     stoploss_mock = mocker.patch(f"{EXMS}.cancel_stoploss_order", side_effect=InvalidOrderException)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     res = rpc._rpc_delete("3")
# REMOVED_UNUSED_CODE:     assert stoploss_mock.call_count == 1
# REMOVED_UNUSED_CODE:     stoploss_mock.reset_mock()
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     cancel_mock = mocker.patch(f"{EXMS}.cancel_order", side_effect=InvalidOrderException)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     res = rpc._rpc_delete("4")
# REMOVED_UNUSED_CODE:     assert cancel_mock.call_count == 1
# REMOVED_UNUSED_CODE:     assert stoploss_mock.call_count == 0
...
# REMOVED_UNUSED_CODE:     freqtradebot.strategy.position_adjustment_enable = True
