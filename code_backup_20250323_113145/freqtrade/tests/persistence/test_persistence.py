...
# REMOVED_UNUSED_CODE:     oobj._trade_live = trade
    oobj.update_from_ccxt_object(entry_order)
    trade.update_trade(oobj)

# REMOVED_UNUSED_CODE:     trade.funding_fee_running = funding_fees
...
# REMOVED_UNUSED_CODE:     order.ft_trade_id = 1
...
# REMOVED_UNUSED_CODE:     order1.stop_price = order1.price * 0.9
# REMOVED_UNUSED_CODE:     order1.ft_trade_id = 1
