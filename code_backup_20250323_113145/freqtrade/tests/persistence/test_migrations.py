...
# REMOVED_UNUSED_CODE: from freqtrade.enums import TradingMode
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: spot, margin, futures = TradingMode.SPOT, TradingMode.MARGIN, TradingMode.FUTURES
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     mocker.patch("freqtrade.persistence.models.create_engine", lambda *args, **kwargs: engine)
...
# REMOVED_UNUSED_CODE:     engine.name = "postgresql"
...
# REMOVED_UNUSED_CODE:     engine.name = "somethingelse"
    get_last_sequence_ids(engine, "trades_bak", "orders_bak")
