...
# REMOVED_UNUSED_CODE: from unittest.mock import MagicMock, PropertyMock
...
# REMOVED_UNUSED_CODE:     backtesting_mock.__name__ = PropertyMock("start_backtesting")
...
# REMOVED_UNUSED_CODE:     hyperopt_mock.__name__ = PropertyMock("start_hyperopt")
...
# REMOVED_UNUSED_CODE:     worker._config = conf
