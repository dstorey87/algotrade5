...
# REMOVED_UNUSED_CODE: from tests.conftest import get_patched_exchange, is_mac
...
# REMOVED_UNUSED_CODE:     timerange, train_period_days, expected_result, freqai_conf, mocker, caplog
):
