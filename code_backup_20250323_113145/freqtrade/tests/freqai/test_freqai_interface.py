...
# REMOVED_UNUSED_CODE:     strategy.freqai_info = freqai_conf.get("freqai", {})
    freqai = strategy.freqai
# REMOVED_UNUSED_CODE:     freqai.live = True
# REMOVED_UNUSED_CODE:     freqai.activate_tensorboard = test_tb
    freqai.can_short = can_short
    freqai.dk = FreqaiDataKitchen(freqai_conf)
# REMOVED_UNUSED_CODE:     freqai.dk.live = True
    freqai.dk.set_paths("ADA/BTC", 10000)
    timerange = TimeRange.parse_timerange("20180110-20180130")
    freqai.dd.load_all_pair_histories(timerange, freqai.dk)

# REMOVED_UNUSED_CODE:     freqai.dd.pair_dict = MagicMock()
...
# REMOVED_UNUSED_CODE:     if "PyTorchMLPClassifier":
# REMOVED_UNUSED_CODE:         pytorch_mlp_mtp = mock_pytorch_mlp_model_training_parameters()
# REMOVED_UNUSED_CODE:         freqai_conf["freqai"]["model_training_parameters"].update(pytorch_mlp_mtp)
...
# REMOVED_UNUSED_CODE:     strategy.freqai_info = freqai_conf.get("freqai", {})
    freqai = strategy.freqai
# REMOVED_UNUSED_CODE:     freqai.live = False
# REMOVED_UNUSED_CODE:     freqai.activate_tensorboard = test_tb
    freqai.dk = FreqaiDataKitchen(freqai_conf)
    timerange = TimeRange.parse_timerange("20180110-20180130")
    freqai.dd.load_all_pair_histories(timerange, freqai.dk)
...
# REMOVED_UNUSED_CODE:     Trade.use_db = True
    Backtesting.cleanup()
    shutil.rmtree(Path(freqai.dk.full_path))
...
# REMOVED_UNUSED_CODE:     freqai.dd.pair_dict = {
# REMOVED_UNUSED_CODE:         "ADA/BTC": {
# REMOVED_UNUSED_CODE:             "model_filename": "fake_name",
# REMOVED_UNUSED_CODE:             "trained_timestamp": 1,
...
# REMOVED_UNUSED_CODE:     freqai.train_queue = freqai._set_train_queue()
...
def test_get_state_info(mocker, freqai_conf, dp_exists, caplog, tickers):
    ...
    if not dp_exists:
# REMOVED_UNUSED_CODE:         strategy.dp._exchange = None

# REMOVED_UNUSED_CODE:     strategy.freqai_info = freqai_conf.get("freqai", {})
    freqai = strategy.freqai
# REMOVED_UNUSED_CODE:     freqai.data_provider = strategy.dp
# REMOVED_UNUSED_CODE:     freqai.live = True
