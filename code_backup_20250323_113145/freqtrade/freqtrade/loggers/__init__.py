...
# REMOVED_UNUSED_CODE: error_console = Console(stderr=True, color_system=None)


# REMOVED_UNUSED_CODE: def get_existing_handlers(handlertype):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Returns Existing handler or None (if the handler has not yet been added to the root handlers).
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     return next((h for h in logging.root.handlers if isinstance(h, handlertype)), None)
