...
# REMOVED_UNUSED_CODE: def render_template(templatefile: str, arguments: dict) -> str:
# REMOVED_UNUSED_CODE:     from jinja2 import Environment, PackageLoader, select_autoescape
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     env = Environment(
# REMOVED_UNUSED_CODE:         loader=PackageLoader("freqtrade", "templates"),
# REMOVED_UNUSED_CODE:         autoescape=select_autoescape(["html", "xml"]),
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     template = env.get_template(templatefile)
# REMOVED_UNUSED_CODE:     return template.render(**arguments)
