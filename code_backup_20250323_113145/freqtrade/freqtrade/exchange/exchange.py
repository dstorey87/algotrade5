...
class Exchange:
    ...
    def __init__(
        ...
        *,
        ...
        self._markets: dict = {}
# REMOVED_UNUSED_CODE:         self._trading_fees: dict[str, Any] = {}
...
# REMOVED_UNUSED_CODE:     def get_markets(
# REMOVED_UNUSED_CODE:         self,
# REMOVED_UNUSED_CODE:         base_currencies: list[str] | None = None,
# REMOVED_UNUSED_CODE:         quote_currencies: list[str] | None = None,
# REMOVED_UNUSED_CODE:         spot_only: bool = False,
# REMOVED_UNUSED_CODE:         margin_only: bool = False,
# REMOVED_UNUSED_CODE:         futures_only: bool = False,
# REMOVED_UNUSED_CODE:         tradable_only: bool = True,
# REMOVED_UNUSED_CODE:         active_only: bool = False,
# REMOVED_UNUSED_CODE:     ) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Return exchange ccxt markets, filtered out by base currency and quote currency
# REMOVED_UNUSED_CODE:         if this was requested in parameters.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         markets = self.markets
# REMOVED_UNUSED_CODE:         if not markets:
# REMOVED_UNUSED_CODE:             raise OperationalException("Markets were not loaded.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if base_currencies:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if v["base"] in base_currencies}
# REMOVED_UNUSED_CODE:         if quote_currencies:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if v["quote"] in quote_currencies}
# REMOVED_UNUSED_CODE:         if tradable_only:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if self.market_is_tradable(v)}
# REMOVED_UNUSED_CODE:         if spot_only:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if self.market_is_spot(v)}
# REMOVED_UNUSED_CODE:         if margin_only:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if self.market_is_margin(v)}
# REMOVED_UNUSED_CODE:         if futures_only:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if self.market_is_future(v)}
# REMOVED_UNUSED_CODE:         if active_only:
# REMOVED_UNUSED_CODE:             markets = {k: v for k, v in markets.items() if market_is_active(v)}
# REMOVED_UNUSED_CODE:         return markets
...
# REMOVED_UNUSED_CODE:     def ws_connection_reset(self):
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         called at regular intervals to reset the websocket connection
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if self._exchange_ws:
# REMOVED_UNUSED_CODE:             self._exchange_ws.reset_connections()
...
# REMOVED_UNUSED_CODE:                 self._trading_fees = self.fetch_trading_fees()
...
# REMOVED_UNUSED_CODE:     def get_option(self, param: str, default: Any | None = None) -> Any:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Get parameter value from _ft_has
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return self._ft_has.get(param, default)
...
# REMOVED_UNUSED_CODE:     def price_get_one_pip(self, pair: str, price: float) -> float:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Gets the "1 pip" value for this pair.
# REMOVED_UNUSED_CODE:         Used in PriceFilter to calculate the 1pip movements.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         precision = self.markets[pair]["precision"]["price"]
# REMOVED_UNUSED_CODE:         if self.precisionMode == TICK_SIZE:
# REMOVED_UNUSED_CODE:             return precision
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             return 1 / pow(10, precision)

# REMOVED_UNUSED_CODE:     def get_min_pair_stake_amount(
# REMOVED_UNUSED_CODE:         self, pair: str, price: float, stoploss: float, leverage: float | None = 1.0
# REMOVED_UNUSED_CODE:     ) -> float | None:
# REMOVED_UNUSED_CODE:         return self._get_stake_amount_limit(pair, price, stoploss, "min", leverage)

# REMOVED_UNUSED_CODE:     def get_max_pair_stake_amount(self, pair: str, price: float, leverage: float = 1.0) -> float:
# REMOVED_UNUSED_CODE:         max_stake_amount = self._get_stake_amount_limit(pair, price, 0.0, "max", leverage)
# REMOVED_UNUSED_CODE:         if max_stake_amount is None:
# REMOVED_UNUSED_CODE:             # * Should never be executed
# REMOVED_UNUSED_CODE:             raise OperationalException(
# REMOVED_UNUSED_CODE:                 f"{self.name}.get_max_pair_stake_amount should never set max_stake_amount to None"
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:         return max_stake_amount
...
# REMOVED_UNUSED_CODE:     def stoploss_adjust(self, stop_loss: float, order: CcxtOrder, side: str) -> bool:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Verify stop_loss against stoploss-order value (limit or price)
# REMOVED_UNUSED_CODE:         Returns True if adjustment is necessary.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if not self._ft_has.get("stoploss_on_exchange"):
# REMOVED_UNUSED_CODE:             raise OperationalException(f"stoploss is not implemented for {self.name}.")
# REMOVED_UNUSED_CODE:         price_param = self._ft_has["stop_price_prop"]
# REMOVED_UNUSED_CODE:         return order.get(price_param, None) is None or (
# REMOVED_UNUSED_CODE:             (side == "sell" and stop_loss > float(order[price_param]))
# REMOVED_UNUSED_CODE:             or (side == "buy" and stop_loss < float(order[price_param]))
# REMOVED_UNUSED_CODE:         )
...
# REMOVED_UNUSED_CODE:     @retrier(retries=0)
    def create_stoploss(
        self,
        pair: str,
        amount: float,
...
# REMOVED_UNUSED_CODE:     def fetch_order_or_stoploss_order(
# REMOVED_UNUSED_CODE:         self, order_id: str, pair: str, stoploss_order: bool = False
# REMOVED_UNUSED_CODE:     ) -> CcxtOrder:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Simple wrapper calling either fetch_order or fetch_stoploss_order depending on
# REMOVED_UNUSED_CODE:         the stoploss_order parameter
# REMOVED_UNUSED_CODE:         :param order_id: OrderId to fetch order
# REMOVED_UNUSED_CODE:         :param pair: Pair corresponding to order_id
# REMOVED_UNUSED_CODE:         :param stoploss_order: If true, uses fetch_stoploss_order, otherwise fetch_order.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if stoploss_order:
# REMOVED_UNUSED_CODE:             return self.fetch_stoploss_order(order_id, pair)
# REMOVED_UNUSED_CODE:         return self.fetch_order(order_id, pair)

# REMOVED_UNUSED_CODE:     def check_order_canceled_empty(self, order: CcxtOrder) -> bool:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Verify if an order has been cancelled without being partially filled
# REMOVED_UNUSED_CODE:         :param order: Order dict as returned from fetch_order()
# REMOVED_UNUSED_CODE:         :return: True if order has been cancelled without being filled, False otherwise.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return order.get("status") in NON_OPEN_EXCHANGE_STATES and order.get("filled") == 0.0
...
# REMOVED_UNUSED_CODE:     def cancel_order_with_result(self, order_id: str, pair: str, amount: float) -> CcxtOrder:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Cancel order returning a result.
# REMOVED_UNUSED_CODE:         Creates a fake result if cancel order returns a non-usable result
# REMOVED_UNUSED_CODE:         and fetch_order does not work (certain exchanges don't return cancelled orders)
# REMOVED_UNUSED_CODE:         :param order_id: Orderid to cancel
# REMOVED_UNUSED_CODE:         :param pair: Pair corresponding to order_id
# REMOVED_UNUSED_CODE:         :param amount: Amount to use for fake response
# REMOVED_UNUSED_CODE:         :return: Result from either cancel_order if usable, or fetch_order
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         try:
# REMOVED_UNUSED_CODE:             corder = self.cancel_order(order_id, pair)
# REMOVED_UNUSED_CODE:             if self.is_cancel_order_result_suitable(corder):
# REMOVED_UNUSED_CODE:                 return corder
# REMOVED_UNUSED_CODE:         except InvalidOrderException:
# REMOVED_UNUSED_CODE:             logger.warning(f"Could not cancel order {order_id} for {pair}.")
# REMOVED_UNUSED_CODE:         try:
# REMOVED_UNUSED_CODE:             order = self.fetch_order(order_id, pair)
# REMOVED_UNUSED_CODE:         except InvalidOrderException:
# REMOVED_UNUSED_CODE:             logger.warning(f"Could not fetch cancelled order {order_id}.")
# REMOVED_UNUSED_CODE:             order = {
# REMOVED_UNUSED_CODE:                 "id": order_id,
# REMOVED_UNUSED_CODE:                 "status": "canceled",
...
# REMOVED_UNUSED_CODE:     def cancel_stoploss_order_with_result(
# REMOVED_UNUSED_CODE:         self, order_id: str, pair: str, amount: float
# REMOVED_UNUSED_CODE:     ) -> CcxtOrder:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Cancel stoploss order returning a result.
# REMOVED_UNUSED_CODE:         Creates a fake result if cancel order returns a non-usable result
# REMOVED_UNUSED_CODE:         and fetch_order does not work (certain exchanges don't return cancelled orders)
# REMOVED_UNUSED_CODE:         :param order_id: stoploss-order-id to cancel
# REMOVED_UNUSED_CODE:         :param pair: Pair corresponding to order_id
# REMOVED_UNUSED_CODE:         :param amount: Amount to use for fake response
# REMOVED_UNUSED_CODE:         :return: Result from either cancel_order if usable, or fetch_order
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         corder = self.cancel_stoploss_order(order_id, pair)
# REMOVED_UNUSED_CODE:         if self.is_cancel_order_result_suitable(corder):
# REMOVED_UNUSED_CODE:             return corder
# REMOVED_UNUSED_CODE:         try:
# REMOVED_UNUSED_CODE:             order = self.fetch_stoploss_order(order_id, pair)
# REMOVED_UNUSED_CODE:         except InvalidOrderException:
# REMOVED_UNUSED_CODE:             logger.warning(f"Could not fetch cancelled stoploss order {order_id}.")
# REMOVED_UNUSED_CODE:             order = {"id": order_id, "fee": {}, "status": "canceled", "amount": amount, "info": {}}
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         return order
...
# REMOVED_UNUSED_CODE:     def get_proxy_coin(self) -> str:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Get the proxy coin for the given coin
# REMOVED_UNUSED_CODE:         Falls back to the stake currency if no proxy coin is found
# REMOVED_UNUSED_CODE:         :return: Proxy coin or stake currency
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return self._config["stake_currency"]
...
# REMOVED_UNUSED_CODE:     def get_rates(self, pair: str, refresh: bool, is_short: bool) -> tuple[float, float]:
# REMOVED_UNUSED_CODE:         entry_rate = None
# REMOVED_UNUSED_CODE:         exit_rate = None
# REMOVED_UNUSED_CODE:         if not refresh:
# REMOVED_UNUSED_CODE:             with self._cache_lock:
# REMOVED_UNUSED_CODE:                 entry_rate = self._entry_rate_cache.get(pair)
# REMOVED_UNUSED_CODE:                 exit_rate = self._exit_rate_cache.get(pair)
# REMOVED_UNUSED_CODE:             if entry_rate:
# REMOVED_UNUSED_CODE:                 logger.debug(f"Using cached buy rate for {pair}.")
# REMOVED_UNUSED_CODE:             if exit_rate:
# REMOVED_UNUSED_CODE:                 logger.debug(f"Using cached sell rate for {pair}.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         entry_pricing = self._config.get("entry_pricing", {})
# REMOVED_UNUSED_CODE:         exit_pricing = self._config.get("exit_pricing", {})
# REMOVED_UNUSED_CODE:         order_book = ticker = None
# REMOVED_UNUSED_CODE:         if not entry_rate and entry_pricing.get("use_order_book", False):
# REMOVED_UNUSED_CODE:             order_book_top = max(
# REMOVED_UNUSED_CODE:                 entry_pricing.get("order_book_top", 1), exit_pricing.get("order_book_top", 1)
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:             order_book = self.fetch_l2_order_book(pair, order_book_top)
# REMOVED_UNUSED_CODE:             entry_rate = self.get_rate(pair, refresh, "entry", is_short, order_book=order_book)
# REMOVED_UNUSED_CODE:         elif not entry_rate:
# REMOVED_UNUSED_CODE:             ticker = self.fetch_ticker(pair)
# REMOVED_UNUSED_CODE:             entry_rate = self.get_rate(pair, refresh, "entry", is_short, ticker=ticker)
# REMOVED_UNUSED_CODE:         if not exit_rate:
# REMOVED_UNUSED_CODE:             exit_rate = self.get_rate(
# REMOVED_UNUSED_CODE:                 pair, refresh, "exit", is_short, order_book=order_book, ticker=ticker
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:         return entry_rate, exit_rate
...
# REMOVED_UNUSED_CODE:     def get_order_id_conditional(self, order: CcxtOrder) -> str:
# REMOVED_UNUSED_CODE:         return order["id"]
...
# REMOVED_UNUSED_CODE:     def extract_cost_curr_rate(
# REMOVED_UNUSED_CODE:         self, fee: dict[str, Any], symbol: str, cost: float, amount: float
# REMOVED_UNUSED_CODE:     ) -> tuple[float, str, float | None]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Extract tuple of cost, currency, rate.
# REMOVED_UNUSED_CODE:         Requires order_has_fee to run first!
# REMOVED_UNUSED_CODE:         :param fee: ccxt Fee dict - must contain cost / currency / rate
# REMOVED_UNUSED_CODE:         :param symbol: Symbol of the order
# REMOVED_UNUSED_CODE:         :param cost: Total cost of the order
# REMOVED_UNUSED_CODE:         :param amount: Amount of the order
# REMOVED_UNUSED_CODE:         :return: Tuple with cost, currency, rate of the given fee dict
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return (
# REMOVED_UNUSED_CODE:             float(fee["cost"]),
# REMOVED_UNUSED_CODE:             fee["currency"],
# REMOVED_UNUSED_CODE:             self.calculate_fee_rate(fee, symbol, cost, amount),
# REMOVED_UNUSED_CODE:         )
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         is_new_pair: bool = False,
# REMOVED_UNUSED_CODE:         until_ms: int | None = None,
# REMOVED_UNUSED_CODE:     ) -> DataFrame:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Get candle history using asyncio and returns the list of candles.
# REMOVED_UNUSED_CODE:         Handles all async work for this.
# REMOVED_UNUSED_CODE:         Async over one pair, assuming we get `self.ohlcv_candle_limit()` candles per call.
# REMOVED_UNUSED_CODE:         :param pair: Pair to download
# REMOVED_UNUSED_CODE:         :param timeframe: Timeframe to get data for
# REMOVED_UNUSED_CODE:         :param since_ms: Timestamp in milliseconds to get history from
# REMOVED_UNUSED_CODE:         :param candle_type: '', mark, index, premiumIndex, or funding_rate
# REMOVED_UNUSED_CODE:         :param is_new_pair: used by binance subclass to allow "fast" new pair downloading
# REMOVED_UNUSED_CODE:         :param until_ms: Timestamp in milliseconds to get history up to
# REMOVED_UNUSED_CODE:         :return: Dataframe with candle (OHLCV) data
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         with self._loop_lock:
# REMOVED_UNUSED_CODE:             pair, _, _, data, _ = self.loop.run_until_complete(
# REMOVED_UNUSED_CODE:                 self._async_get_historic_ohlcv(
...
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:         logger.debug(f"Downloaded data for {pair} from ccxt with length {len(data)}.")
# REMOVED_UNUSED_CODE:         return ohlcv_to_dataframe(data, timeframe, pair, fill_missing=False, drop_incomplete=True)
...
# REMOVED_UNUSED_CODE:     def refresh_ohlcv_with_cache(
# REMOVED_UNUSED_CODE:         self, pairs: list[PairWithTimeframe], since_ms: int
# REMOVED_UNUSED_CODE:     ) -> dict[PairWithTimeframe, DataFrame]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Refresh ohlcv data for all pairs in needed_pairs if necessary.
# REMOVED_UNUSED_CODE:         Caches data with expiring per timeframe.
# REMOVED_UNUSED_CODE:         Should only be used for pairlists which need "on time" expirarion, and no longer cache.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         timeframes = {p[1] for p in pairs}
# REMOVED_UNUSED_CODE:         for timeframe in timeframes:
# REMOVED_UNUSED_CODE:             if (timeframe, since_ms) not in self._expiring_candle_cache:
# REMOVED_UNUSED_CODE:                 timeframe_in_sec = timeframe_to_seconds(timeframe)
# REMOVED_UNUSED_CODE:                 # Initialise cache
# REMOVED_UNUSED_CODE:                 self._expiring_candle_cache[(timeframe, since_ms)] = PeriodicCache(
# REMOVED_UNUSED_CODE:                     ttl=timeframe_in_sec, maxsize=1000
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         # Get candles from cache
# REMOVED_UNUSED_CODE:         candles = {
# REMOVED_UNUSED_CODE:             c: self._expiring_candle_cache[(c[1], since_ms)].get(c, None)
# REMOVED_UNUSED_CODE:             for c in pairs
# REMOVED_UNUSED_CODE:             if c in self._expiring_candle_cache[(c[1], since_ms)]
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:         pairs_to_download = [p for p in pairs if p not in candles]
# REMOVED_UNUSED_CODE:         if pairs_to_download:
# REMOVED_UNUSED_CODE:             candles = self.refresh_latest_ohlcv(pairs_to_download, since_ms=since_ms, cache=False)
# REMOVED_UNUSED_CODE:             for c, val in candles.items():
# REMOVED_UNUSED_CODE:                 self._expiring_candle_cache[(c[1], since_ms)][c] = val
...
# REMOVED_UNUSED_CODE:     def get_historic_trades(
# REMOVED_UNUSED_CODE:         self,
# REMOVED_UNUSED_CODE:         pair: str,
# REMOVED_UNUSED_CODE:         since: int,
# REMOVED_UNUSED_CODE:         until: int | None = None,
# REMOVED_UNUSED_CODE:         from_id: str | None = None,
# REMOVED_UNUSED_CODE:     ) -> tuple[str, list]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Get trade history data using asyncio.
# REMOVED_UNUSED_CODE:         Handles all async work and returns the list of candles.
# REMOVED_UNUSED_CODE:         Async over one pair, assuming we get `self.ohlcv_candle_limit()` candles per call.
# REMOVED_UNUSED_CODE:         :param pair: Pair to download
# REMOVED_UNUSED_CODE:         :param since: Timestamp in milliseconds to get history from
# REMOVED_UNUSED_CODE:         :param until: Timestamp in milliseconds. Defaults to current timestamp if not defined.
# REMOVED_UNUSED_CODE:         :param from_id: Download data starting with ID (if id is known)
# REMOVED_UNUSED_CODE:         :returns List of trade data
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if not self.exchange_has("fetchTrades"):
# REMOVED_UNUSED_CODE:             raise OperationalException("This exchange does not support downloading Trades.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         with self._loop_lock:
# REMOVED_UNUSED_CODE:             task = asyncio.ensure_future(
# REMOVED_UNUSED_CODE:                 self._async_get_trade_history(pair=pair, since=since, until=until, from_id=from_id)
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             for sig in [signal.SIGINT, signal.SIGTERM]:
# REMOVED_UNUSED_CODE:                 try:
# REMOVED_UNUSED_CODE:                     self.loop.add_signal_handler(sig, task.cancel)
# REMOVED_UNUSED_CODE:                 except NotImplementedError:
# REMOVED_UNUSED_CODE:                     # Not all platforms implement signals (e.g. windows)
# REMOVED_UNUSED_CODE:                     pass
# REMOVED_UNUSED_CODE:             return self.loop.run_until_complete(task)
...
# REMOVED_UNUSED_CODE:     def get_max_leverage(self, pair: str, stake_amount: float | None) -> float:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Returns the maximum leverage that a pair can be traded at
# REMOVED_UNUSED_CODE:         :param pair: The base/quote currency pair being traded
# REMOVED_UNUSED_CODE:         :stake_amount: The total value of the traders margin_mode in quote currency
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE:             # Checks and edge cases
# REMOVED_UNUSED_CODE:             if stake_amount is None:
# REMOVED_UNUSED_CODE:                 raise OperationalException(
# REMOVED_UNUSED_CODE:                     f"{self.name}.get_max_leverage requires argument stake_amount"
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             if pair not in self._leverage_tiers:
# REMOVED_UNUSED_CODE:                 # Maybe raise exception because it can't be traded on futures?
# REMOVED_UNUSED_CODE:                 return 1.0
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             pair_tiers = self._leverage_tiers[pair]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             if stake_amount == 0:
# REMOVED_UNUSED_CODE:                 return self._leverage_tiers[pair][0]["maxLeverage"]  # Max lev for lowest amount
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             for tier_index in range(len(pair_tiers)):
# REMOVED_UNUSED_CODE:                 tier = pair_tiers[tier_index]
# REMOVED_UNUSED_CODE:                 lev = tier["maxLeverage"]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 if tier_index < len(pair_tiers) - 1:
# REMOVED_UNUSED_CODE:                     next_tier = pair_tiers[tier_index + 1]
# REMOVED_UNUSED_CODE:                     next_floor = next_tier["minNotional"] / next_tier["maxLeverage"]
# REMOVED_UNUSED_CODE:                     if next_floor > stake_amount:  # Next tier min too high for stake amount
# REMOVED_UNUSED_CODE:                         return min((tier["maxNotional"] / stake_amount), lev)
# REMOVED_UNUSED_CODE:                         #
# REMOVED_UNUSED_CODE:                         # With the two leverage tiers below,
# REMOVED_UNUSED_CODE:                         # - a stake amount of 150 would mean a max leverage of (10000 / 150) = 66.66
# REMOVED_UNUSED_CODE:                         # - stakes below 133.33 = max_lev of 75
# REMOVED_UNUSED_CODE:                         # - stakes between 133.33-200 = max_lev of 10000/stake = 50.01-74.99
# REMOVED_UNUSED_CODE:                         # - stakes from 200 + 1000 = max_lev of 50
# REMOVED_UNUSED_CODE:                         #
# REMOVED_UNUSED_CODE:                         # {
# REMOVED_UNUSED_CODE:                         #     "min": 0,      # stake = 0.0
# REMOVED_UNUSED_CODE:                         #     "max": 10000,  # max_stake@75 = 10000/75 = 133.33333333333334
# REMOVED_UNUSED_CODE:                         #     "lev": 75,
# REMOVED_UNUSED_CODE:                         # },
# REMOVED_UNUSED_CODE:                         # {
# REMOVED_UNUSED_CODE:                         #     "min": 10000,  # stake = 200.0
# REMOVED_UNUSED_CODE:                         #     "max": 50000,  # max_stake@50 = 50000/50 = 1000.0
# REMOVED_UNUSED_CODE:                         #     "lev": 50,
# REMOVED_UNUSED_CODE:                         # }
# REMOVED_UNUSED_CODE:                         #
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 else:  # if on the last tier
# REMOVED_UNUSED_CODE:                     if stake_amount > tier["maxNotional"]:
# REMOVED_UNUSED_CODE:                         # If stake is > than max tradeable amount
# REMOVED_UNUSED_CODE:                         raise InvalidOrderException(f"Amount {stake_amount} too high for {pair}")
# REMOVED_UNUSED_CODE:                     else:
# REMOVED_UNUSED_CODE:                         return tier["maxLeverage"]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             raise OperationalException(
# REMOVED_UNUSED_CODE:                 "Looped through all tiers without finding a max leverage. Should never be reached"
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         elif self.trading_mode == TradingMode.MARGIN:  # Search markets.limits for max lev
# REMOVED_UNUSED_CODE:             market = self.markets[pair]
# REMOVED_UNUSED_CODE:             if market["limits"]["leverage"]["max"] is not None:
# REMOVED_UNUSED_CODE:                 return market["limits"]["leverage"]["max"]
# REMOVED_UNUSED_CODE:             else:
# REMOVED_UNUSED_CODE:                 return 1.0  # Default if max leverage cannot be found
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             return 1.0
...
# REMOVED_UNUSED_CODE:     def get_interest_rate(self) -> float:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Retrieve interest rate - necessary for Margin trading.
# REMOVED_UNUSED_CODE:         Should not call the exchange directly when used from backtesting.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         return 0.0
    ...
    def calculate_funding_fees(
        ...
        open_date: datetime,
        close_date: datetime,
# REMOVED_UNUSED_CODE:         time_in_ratio: float | None = None,
    ) -> float:
        """
...
# REMOVED_UNUSED_CODE:     def get_funding_fees(
# REMOVED_UNUSED_CODE:         self, pair: str, amount: float, is_short: bool, open_date: datetime
# REMOVED_UNUSED_CODE:     ) -> float:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Fetch funding fees, either from the exchange (live) or calculates them
# REMOVED_UNUSED_CODE:         based on funding rate/mark price history
# REMOVED_UNUSED_CODE:         :param pair: The quote/base pair of the trade
# REMOVED_UNUSED_CODE:         :param is_short: trade direction
# REMOVED_UNUSED_CODE:         :param amount: Trade amount
# REMOVED_UNUSED_CODE:         :param open_date: Open date of the trade
# REMOVED_UNUSED_CODE:         :return: funding fee since open_date
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if self.trading_mode == TradingMode.FUTURES:
# REMOVED_UNUSED_CODE:             try:
# REMOVED_UNUSED_CODE:                 if self._config["dry_run"]:
# REMOVED_UNUSED_CODE:                     funding_fees = self._fetch_and_calculate_funding_fees(
# REMOVED_UNUSED_CODE:                         pair, amount, is_short, open_date
# REMOVED_UNUSED_CODE:                     )
# REMOVED_UNUSED_CODE:                 else:
# REMOVED_UNUSED_CODE:                     funding_fees = self._get_funding_fees_from_exchange(pair, open_date)
# REMOVED_UNUSED_CODE:                 return funding_fees
# REMOVED_UNUSED_CODE:             except ExchangeError:
# REMOVED_UNUSED_CODE:                 logger.warning(f"Could not update funding fees for {pair}.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         return 0.0

# REMOVED_UNUSED_CODE:     def get_liquidation_price(
# REMOVED_UNUSED_CODE:         self,
# REMOVED_UNUSED_CODE:         pair: str,
# REMOVED_UNUSED_CODE:         # Dry-run
# REMOVED_UNUSED_CODE:         open_rate: float,  # Entry price of position
# REMOVED_UNUSED_CODE:         is_short: bool,
# REMOVED_UNUSED_CODE:         amount: float,  # Absolute value of position size
# REMOVED_UNUSED_CODE:         stake_amount: float,
# REMOVED_UNUSED_CODE:         leverage: float,
# REMOVED_UNUSED_CODE:         wallet_balance: float,
# REMOVED_UNUSED_CODE:         open_trades: list | None = None,
# REMOVED_UNUSED_CODE:     ) -> float | None:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Set's the margin mode on the exchange to cross or isolated for a specific pair
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         if self.trading_mode == TradingMode.SPOT:
# REMOVED_UNUSED_CODE:             return None
# REMOVED_UNUSED_CODE:         elif self.trading_mode != TradingMode.FUTURES:
# REMOVED_UNUSED_CODE:             raise OperationalException(
# REMOVED_UNUSED_CODE:                 f"{self.name} does not support {self.margin_mode} {self.trading_mode}"
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         liquidation_price = None
# REMOVED_UNUSED_CODE:         if self._config["dry_run"] or not self.exchange_has("fetchPositions"):
# REMOVED_UNUSED_CODE:             liquidation_price = self.dry_run_liquidation_price(
# REMOVED_UNUSED_CODE:                 pair=pair,
...
# REMOVED_UNUSED_CODE:                 wallet_balance=wallet_balance,
# REMOVED_UNUSED_CODE:                 open_trades=open_trades or [],
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             positions = self.fetch_positions(pair)
# REMOVED_UNUSED_CODE:             if len(positions) > 0:
# REMOVED_UNUSED_CODE:                 pos = positions[0]
# REMOVED_UNUSED_CODE:                 liquidation_price = pos["liquidationPrice"]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if liquidation_price is not None:
# REMOVED_UNUSED_CODE:             buffer_amount = abs(open_rate - liquidation_price) * self.liquidation_buffer
# REMOVED_UNUSED_CODE:             liquidation_price_buffer = (
# REMOVED_UNUSED_CODE:                 liquidation_price - buffer_amount if is_short else liquidation_price + buffer_amount
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:             return max(liquidation_price_buffer, 0.0)
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             return None
