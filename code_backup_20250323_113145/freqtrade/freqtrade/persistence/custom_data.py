...
# REMOVED_UNUSED_CODE:     value: Any = None
...
# REMOVED_UNUSED_CODE:             data.value = data.cd_value
            if data.cd_type == "bool":
# REMOVED_UNUSED_CODE:                 data.value = data.cd_value.lower() == "true"
            elif data.cd_type == "int":
# REMOVED_UNUSED_CODE:                 data.value = int(data.cd_value)
            elif data.cd_type == "float":
# REMOVED_UNUSED_CODE:                 data.value = float(data.cd_value)
        else:
# REMOVED_UNUSED_CODE:             data.value = json.loads(data.cd_value)
        return data
