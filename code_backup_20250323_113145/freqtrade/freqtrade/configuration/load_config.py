...
# REMOVED_UNUSED_CODE: def load_file(path: Path) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:     try:
# REMOVED_UNUSED_CODE:         with path.open("r") as file:
# REMOVED_UNUSED_CODE:             config = rapidjson.load(file, parse_mode=CONFIG_PARSE_MODE)
# REMOVED_UNUSED_CODE:     except FileNotFoundError:
# REMOVED_UNUSED_CODE:         raise OperationalException(f'File "{path}" not found!') from None
