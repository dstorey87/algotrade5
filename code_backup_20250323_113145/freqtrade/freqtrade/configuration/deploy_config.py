import logging
# REMOVED_UNUSED_CODE: import secrets
# REMOVED_UNUSED_CODE: from pathlib import Path
# REMOVED_UNUSED_CODE: from typing import Any

# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from questionary import Separator, prompt
...
# REMOVED_UNUSED_CODE: def validate_is_int(val):
# REMOVED_UNUSED_CODE:     try:
# REMOVED_UNUSED_CODE:         _ = int(val)
# REMOVED_UNUSED_CODE:         return True
# REMOVED_UNUSED_CODE:     except Exception:
# REMOVED_UNUSED_CODE:         return False


# REMOVED_UNUSED_CODE: def validate_is_float(val):
# REMOVED_UNUSED_CODE:     try:
# REMOVED_UNUSED_CODE:         _ = float(val)
# REMOVED_UNUSED_CODE:         return True
# REMOVED_UNUSED_CODE:     except Exception:
# REMOVED_UNUSED_CODE:         return False
