...
# REMOVED_UNUSED_CODE:     backtesting.trading_mode = TradingMode.MARGIN
    backtesting._set_strategy(backtesting.strategylist[0])
# REMOVED_UNUSED_CODE:     backtesting._can_short = True
# REMOVED_UNUSED_CODE:     backtesting.required_startup = 0
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     backtesting.strategy.advise_entry = lambda a, m: frame
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     backtesting.strategy.advise_exit = lambda a, m: frame
...
# REMOVED_UNUSED_CODE:     backtesting.strategy.leverage = lambda **kwargs: data.leverage
