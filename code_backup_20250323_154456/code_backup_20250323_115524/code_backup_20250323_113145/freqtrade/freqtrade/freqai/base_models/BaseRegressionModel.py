...
# REMOVED_UNUSED_CODE: class BaseRegressionModel(IFreqaiModel):
# REMOVED_UNUSED_CODE:     """
...
# REMOVED_UNUSED_CODE:     such as prediction_models/CatboostRegressor.py for guidance.
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         dk.label_pipeline = self.define_label_pipeline(threads=dk.thread_count)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         dd["train_labels"], _, _ = dk.label_pipeline.fit_transform(dd["train_labels"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             dd["test_labels"], _, _ = dk.label_pipeline.transform(dd["test_labels"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         logger.info(
...
# REMOVED_UNUSED_CODE:         dk.data_dictionary["prediction_features"], _ = dk.filter_features(
...
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         pred_df, _, _ = dk.label_pipeline.inverse_transform(pred_df)
