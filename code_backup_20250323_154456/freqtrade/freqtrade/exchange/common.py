...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from typing import Any, TypeVar, cast, overload

# REMOVED_UNUSED_CODE: from freqtrade.constants import ExchangeConfig
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.exceptions import DDosProtection, RetryableOrderError, TemporaryError
# REMOVED_UNUSED_CODE: from freqtrade.mixins import LoggingMixin


# REMOVED_UNUSED_CODE: logger = logging.getLogger(__name__)
# REMOVED_UNUSED_CODE: __logging_mixin = None
...
# REMOVED_UNUSED_CODE: def _get_logging_mixin():
# REMOVED_UNUSED_CODE:     # Logging-mixin to cache kucoin responses
# REMOVED_UNUSED_CODE:     # Only to be used in retrier
# REMOVED_UNUSED_CODE:     global __logging_mixin
# REMOVED_UNUSED_CODE:     if not __logging_mixin:
# REMOVED_UNUSED_CODE:         __logging_mixin = LoggingMixin(logger)
# REMOVED_UNUSED_CODE:     return __logging_mixin


# Maximum default retry count.
# Functions are always called RETRY_COUNT + 1 times (for the original call)
# REMOVED_UNUSED_CODE: API_RETRY_COUNT = 4
...
# REMOVED_UNUSED_CODE: def calculate_backoff(retrycount, max_retries):
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     Calculate backoff
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     return (max_retries - retrycount) ** 2 + 1
...
# REMOVED_UNUSED_CODE: def retrier(_func: F) -> F: ...


# REMOVED_UNUSED_CODE: @overload
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: def retrier(_func: F, *, retries=API_RETRY_COUNT) -> F: ...


# REMOVED_UNUSED_CODE: @overload
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: def retrier(*, retries=API_RETRY_COUNT) -> Callable[[F], F]: ...
