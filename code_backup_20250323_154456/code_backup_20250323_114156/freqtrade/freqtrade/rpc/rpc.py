...
# REMOVED_UNUSED_CODE:     def _rpc_show_config(
# REMOVED_UNUSED_CODE:         config, botstate: State | str, strategy_version: str | None = None
# REMOVED_UNUSED_CODE:     ) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Return a dict of config options.
# REMOVED_UNUSED_CODE:         Explicitly does NOT return the full config to avoid leakage of sensitive
# REMOVED_UNUSED_CODE:         information via rpc.
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         val = {
# REMOVED_UNUSED_CODE:             "version": __version__,
# REMOVED_UNUSED_CODE:             "strategy_version": strategy_version,
# REMOVED_UNUSED_CODE:             "dry_run": config["dry_run"],
# REMOVED_UNUSED_CODE:             "trading_mode": config.get("trading_mode", "spot"),
# REMOVED_UNUSED_CODE:             "short_allowed": config.get("trading_mode", "spot") != "spot",
# REMOVED_UNUSED_CODE:             "stake_currency": config["stake_currency"],
# REMOVED_UNUSED_CODE:             "stake_currency_decimals": decimals_per_coin(config["stake_currency"]),
# REMOVED_UNUSED_CODE:             "stake_amount": str(config["stake_amount"]),
# REMOVED_UNUSED_CODE:             "available_capital": config.get("available_capital"),
# REMOVED_UNUSED_CODE:             "max_open_trades": (
# REMOVED_UNUSED_CODE:                 config.get("max_open_trades", 0)
# REMOVED_UNUSED_CODE:                 if config.get("max_open_trades", 0) != float("inf")
# REMOVED_UNUSED_CODE:                 else -1
# REMOVED_UNUSED_CODE:             ),
# REMOVED_UNUSED_CODE:             "minimal_roi": config["minimal_roi"].copy() if "minimal_roi" in config else {},
# REMOVED_UNUSED_CODE:             "stoploss": config.get("stoploss"),
# REMOVED_UNUSED_CODE:             "stoploss_on_exchange": config.get("order_types", {}).get(
# REMOVED_UNUSED_CODE:                 "stoploss_on_exchange", False
# REMOVED_UNUSED_CODE:             ),
# REMOVED_UNUSED_CODE:             "trailing_stop": config.get("trailing_stop"),
# REMOVED_UNUSED_CODE:             "trailing_stop_positive": config.get("trailing_stop_positive"),
# REMOVED_UNUSED_CODE:             "trailing_stop_positive_offset": config.get("trailing_stop_positive_offset"),
# REMOVED_UNUSED_CODE:             "trailing_only_offset_is_reached": config.get("trailing_only_offset_is_reached"),
# REMOVED_UNUSED_CODE:             "unfilledtimeout": config.get("unfilledtimeout"),
# REMOVED_UNUSED_CODE:             "use_custom_stoploss": config.get("use_custom_stoploss"),
# REMOVED_UNUSED_CODE:             "order_types": config.get("order_types"),
# REMOVED_UNUSED_CODE:             "bot_name": config.get("bot_name", "freqtrade"),
# REMOVED_UNUSED_CODE:             "timeframe": config.get("timeframe"),
# REMOVED_UNUSED_CODE:             "timeframe_ms": timeframe_to_msecs(config["timeframe"]) if "timeframe" in config else 0,
# REMOVED_UNUSED_CODE:             "timeframe_min": (
# REMOVED_UNUSED_CODE:                 timeframe_to_minutes(config["timeframe"]) if "timeframe" in config else 0
# REMOVED_UNUSED_CODE:             ),
# REMOVED_UNUSED_CODE:             "exchange": config["exchange"]["name"],
# REMOVED_UNUSED_CODE:             "strategy": config["strategy"],
# REMOVED_UNUSED_CODE:             "force_entry_enable": config.get("force_entry_enable", False),
# REMOVED_UNUSED_CODE:             "exit_pricing": config.get("exit_pricing", {}),
# REMOVED_UNUSED_CODE:             "entry_pricing": config.get("entry_pricing", {}),
# REMOVED_UNUSED_CODE:             "state": str(botstate),
# REMOVED_UNUSED_CODE:             "runmode": config["runmode"].value,
# REMOVED_UNUSED_CODE:             "position_adjustment_enable": config.get("position_adjustment_enable", False),
# REMOVED_UNUSED_CODE:             "max_entry_position_adjustment": (
# REMOVED_UNUSED_CODE:                 config.get("max_entry_position_adjustment", -1)
# REMOVED_UNUSED_CODE:                 if config.get("max_entry_position_adjustment") != float("inf")
# REMOVED_UNUSED_CODE:                 else -1
# REMOVED_UNUSED_CODE:             ),
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:         return val

# REMOVED_UNUSED_CODE:     def _rpc_trade_status(self, trade_ids: list[int] | None = None) -> list[dict[str, Any]]:
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         Below follows the RPC backend it is prefixed with rpc_ to raise awareness that it is
# REMOVED_UNUSED_CODE:         a remotely exposed function
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         # Fetch open trades
# REMOVED_UNUSED_CODE:         if trade_ids:
# REMOVED_UNUSED_CODE:             trades: Sequence[Trade] = Trade.get_trades(trade_filter=Trade.id.in_(trade_ids)).all()
...
# REMOVED_UNUSED_CODE:                 current_profit_fiat: float | None = None
# REMOVED_UNUSED_CODE:                 total_profit_fiat: float | None = None
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 # prepare open orders details
# REMOVED_UNUSED_CODE:                 oo_details: str | None = ""
# REMOVED_UNUSED_CODE:                 oo_details_lst = [
# REMOVED_UNUSED_CODE:                     f"({oo.order_type} {oo.side} rem={oo.safe_remaining:.8f})"
# REMOVED_UNUSED_CODE:                     for oo in trade.open_orders
# REMOVED_UNUSED_CODE:                     if oo.ft_order_side not in ["stoploss"]
# REMOVED_UNUSED_CODE:                 ]
# REMOVED_UNUSED_CODE:                 oo_details = ", ".join(oo_details_lst)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 total_profit_abs = 0.0
# REMOVED_UNUSED_CODE:                 total_profit_ratio: float | None = None
# REMOVED_UNUSED_CODE:                 # calculate profit and send message to user
# REMOVED_UNUSED_CODE:                 if trade.is_open:
# REMOVED_UNUSED_CODE:                     try:
# REMOVED_UNUSED_CODE:                         current_rate: float = self._freqtrade.exchange.get_rate(
# REMOVED_UNUSED_CODE:                             trade.pair, side="exit", is_short=trade.is_short, refresh=False
# REMOVED_UNUSED_CODE:                         )
# REMOVED_UNUSED_CODE:                     except (ExchangeError, PricingError):
# REMOVED_UNUSED_CODE:                         current_rate = nan
# REMOVED_UNUSED_CODE:                     if len(trade.select_filled_orders(trade.entry_side)) > 0:
# REMOVED_UNUSED_CODE:                         current_profit = current_profit_abs = current_profit_fiat = nan
# REMOVED_UNUSED_CODE:                         if not isnan(current_rate):
# REMOVED_UNUSED_CODE:                             prof = trade.calculate_profit(current_rate)
# REMOVED_UNUSED_CODE:                             current_profit = prof.profit_ratio
# REMOVED_UNUSED_CODE:                             current_profit_abs = prof.profit_abs
# REMOVED_UNUSED_CODE:                             total_profit_abs = prof.total_profit
# REMOVED_UNUSED_CODE:                             total_profit_ratio = prof.total_profit_ratio
# REMOVED_UNUSED_CODE:                     else:
# REMOVED_UNUSED_CODE:                         current_profit = current_profit_abs = current_profit_fiat = 0.0
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 else:
# REMOVED_UNUSED_CODE:                     # Closed trade ...
# REMOVED_UNUSED_CODE:                     current_rate = trade.close_rate or 0.0
# REMOVED_UNUSED_CODE:                     current_profit = trade.close_profit or 0.0
# REMOVED_UNUSED_CODE:                     current_profit_abs = trade.close_profit_abs or 0.0
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 # Calculate fiat profit
# REMOVED_UNUSED_CODE:                 if not isnan(current_profit_abs) and self._fiat_converter:
# REMOVED_UNUSED_CODE:                     current_profit_fiat = self._fiat_converter.convert_amount(
# REMOVED_UNUSED_CODE:                         current_profit_abs,
# REMOVED_UNUSED_CODE:                         self._freqtrade.config["stake_currency"],
# REMOVED_UNUSED_CODE:                         self._freqtrade.config["fiat_display_currency"],
# REMOVED_UNUSED_CODE:                     )
# REMOVED_UNUSED_CODE:                     total_profit_fiat = self._fiat_converter.convert_amount(
# REMOVED_UNUSED_CODE:                         total_profit_abs,
# REMOVED_UNUSED_CODE:                         self._freqtrade.config["stake_currency"],
# REMOVED_UNUSED_CODE:                         self._freqtrade.config["fiat_display_currency"],
# REMOVED_UNUSED_CODE:                     )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 # Calculate guaranteed profit (in case of trailing stop)
# REMOVED_UNUSED_CODE:                 stop_entry = trade.calculate_profit(trade.stop_loss)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 stoploss_entry_dist = stop_entry.profit_abs
# REMOVED_UNUSED_CODE:                 stoploss_entry_dist_ratio = stop_entry.profit_ratio
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 # calculate distance to stoploss
# REMOVED_UNUSED_CODE:                 stoploss_current_dist = price_to_precision(
# REMOVED_UNUSED_CODE:                     trade.stop_loss - current_rate,
# REMOVED_UNUSED_CODE:                     trade.price_precision,
# REMOVED_UNUSED_CODE:                     trade.precision_mode_price,
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 stoploss_current_dist_ratio = stoploss_current_dist / current_rate
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 trade_dict = trade.to_json()
# REMOVED_UNUSED_CODE:                 trade_dict.update(
# REMOVED_UNUSED_CODE:                     dict(
# REMOVED_UNUSED_CODE:                         close_profit=trade.close_profit if not trade.is_open else None,
# REMOVED_UNUSED_CODE:                         current_rate=current_rate,
# REMOVED_UNUSED_CODE:                         profit_ratio=current_profit,
# REMOVED_UNUSED_CODE:                         profit_pct=round(current_profit * 100, 2),
# REMOVED_UNUSED_CODE:                         profit_abs=current_profit_abs,
# REMOVED_UNUSED_CODE:                         profit_fiat=current_profit_fiat,
# REMOVED_UNUSED_CODE:                         total_profit_abs=total_profit_abs,
# REMOVED_UNUSED_CODE:                         total_profit_fiat=total_profit_fiat,
# REMOVED_UNUSED_CODE:                         total_profit_ratio=total_profit_ratio,
# REMOVED_UNUSED_CODE:                         stoploss_current_dist=stoploss_current_dist,
# REMOVED_UNUSED_CODE:                         stoploss_current_dist_ratio=round(stoploss_current_dist_ratio, 8),
# REMOVED_UNUSED_CODE:                         stoploss_current_dist_pct=round(stoploss_current_dist_ratio * 100, 2),
# REMOVED_UNUSED_CODE:                         stoploss_entry_dist=stoploss_entry_dist,
# REMOVED_UNUSED_CODE:                         stoploss_entry_dist_ratio=round(stoploss_entry_dist_ratio, 8),
# REMOVED_UNUSED_CODE:                         open_orders=oo_details,
# REMOVED_UNUSED_CODE:                         nr_of_successful_entries=trade.nr_of_successful_entries,
# REMOVED_UNUSED_CODE:                     )
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 results.append(trade_dict)
# REMOVED_UNUSED_CODE:             return results
...
# REMOVED_UNUSED_CODE:     def __balance_get_est_stake(
# REMOVED_UNUSED_CODE:         self, coin: str, stake_currency: str, amount: float, balance: Wallet
# REMOVED_UNUSED_CODE:     ) -> tuple[float, float]:
# REMOVED_UNUSED_CODE:         est_stake = 0.0
# REMOVED_UNUSED_CODE:         est_bot_stake = 0.0
# REMOVED_UNUSED_CODE:         is_futures = self._config.get("trading_mode", TradingMode.SPOT) == TradingMode.FUTURES
# REMOVED_UNUSED_CODE:         if coin == self._freqtrade.exchange.get_proxy_coin():
# REMOVED_UNUSED_CODE:             est_stake = balance.total
# REMOVED_UNUSED_CODE:             if is_futures:
# REMOVED_UNUSED_CODE:                 # in Futures, "total" includes the locked stake, and therefore all positions
# REMOVED_UNUSED_CODE:                 est_stake = balance.free
# REMOVED_UNUSED_CODE:             est_bot_stake = amount
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             try:
# REMOVED_UNUSED_CODE:                 rate: float | None = self._freqtrade.exchange.get_conversion_rate(
# REMOVED_UNUSED_CODE:                     coin, stake_currency
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 if rate:
# REMOVED_UNUSED_CODE:                     est_stake = rate * (balance.free if is_futures else balance.total)
# REMOVED_UNUSED_CODE:                     est_bot_stake = rate * amount
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                 return est_stake, est_bot_stake
# REMOVED_UNUSED_CODE:             except (ExchangeError, PricingError) as e:
# REMOVED_UNUSED_CODE:                 logger.warning(f"Error {e} getting rate for {coin}")
# REMOVED_UNUSED_CODE:                 pass
# REMOVED_UNUSED_CODE:         return est_stake, est_bot_stake
...
# REMOVED_UNUSED_CODE:     def __exec_force_exit(
# REMOVED_UNUSED_CODE:         self, trade: Trade, ordertype: str | None, amount: float | None = None
# REMOVED_UNUSED_CODE:     ) -> bool:
# REMOVED_UNUSED_CODE:         # Check if there is there are open orders
# REMOVED_UNUSED_CODE:         trade_entry_cancelation_registry = []
# REMOVED_UNUSED_CODE:         for oo in trade.open_orders:
# REMOVED_UNUSED_CODE:             trade_entry_cancelation_res = {"order_id": oo.order_id, "cancel_state": False}
# REMOVED_UNUSED_CODE:             order = self._freqtrade.exchange.fetch_order(oo.order_id, trade.pair)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             if order["side"] == trade.entry_side:
# REMOVED_UNUSED_CODE:                 fully_canceled = self._freqtrade.handle_cancel_enter(
# REMOVED_UNUSED_CODE:                     trade, order, oo, CANCEL_REASON["FORCE_EXIT"]
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 trade_entry_cancelation_res["cancel_state"] = fully_canceled
# REMOVED_UNUSED_CODE:                 trade_entry_cancelation_registry.append(trade_entry_cancelation_res)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             if order["side"] == trade.exit_side:
# REMOVED_UNUSED_CODE:                 # Cancel order - so it is placed anew with a fresh price.
# REMOVED_UNUSED_CODE:                 self._freqtrade.handle_cancel_exit(trade, order, oo, CANCEL_REASON["FORCE_EXIT"])
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if all(tocr["cancel_state"] is False for tocr in trade_entry_cancelation_registry):
# REMOVED_UNUSED_CODE:             if trade.has_open_orders:
# REMOVED_UNUSED_CODE:                 # Order cancellation failed, so we can't exit.
# REMOVED_UNUSED_CODE:                 return False
# REMOVED_UNUSED_CODE:             # Get current rate and execute sell
# REMOVED_UNUSED_CODE:             current_rate = self._freqtrade.exchange.get_rate(
# REMOVED_UNUSED_CODE:                 trade.pair, side="exit", is_short=trade.is_short, refresh=True
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:             exit_check = ExitCheckTuple(exit_type=ExitType.FORCE_EXIT)
# REMOVED_UNUSED_CODE:             order_type = ordertype or self._freqtrade.strategy.order_types.get(
# REMOVED_UNUSED_CODE:                 "force_exit", self._freqtrade.strategy.order_types["exit"]
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:             sub_amount: float | None = None
# REMOVED_UNUSED_CODE:             if amount and amount < trade.amount:
# REMOVED_UNUSED_CODE:                 # Partial exit ...
# REMOVED_UNUSED_CODE:                 min_exit_stake = self._freqtrade.exchange.get_min_pair_stake_amount(
# REMOVED_UNUSED_CODE:                     trade.pair, current_rate, trade.stop_loss_pct or 0.0
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 remaining = (trade.amount - amount) * current_rate
# REMOVED_UNUSED_CODE:                 if min_exit_stake and remaining < min_exit_stake:
# REMOVED_UNUSED_CODE:                     raise RPCException(f"Remaining amount of {remaining} would be too small.")
# REMOVED_UNUSED_CODE:                 sub_amount = amount
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             self._freqtrade.execute_trade_exit(
# REMOVED_UNUSED_CODE:                 trade, current_rate, exit_check, ordertype=order_type, sub_trade_amt=sub_amount
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE:     def _force_entry_validations(self, pair: str, order_side: SignalDirection):
# REMOVED_UNUSED_CODE:         if not self._freqtrade.config.get("force_entry_enable", False):
# REMOVED_UNUSED_CODE:             raise RPCException("Force_entry not enabled.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if self._freqtrade.state != State.RUNNING:
# REMOVED_UNUSED_CODE:             raise RPCException("trader is not running")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if order_side == SignalDirection.SHORT and self._freqtrade.trading_mode == TradingMode.SPOT:
# REMOVED_UNUSED_CODE:             raise RPCException("Can't go short on Spot markets.")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         if pair not in self._freqtrade.exchange.get_markets(tradable_only=True):
# REMOVED_UNUSED_CODE:             raise RPCException("Symbol does not exist or market is not active.")
# REMOVED_UNUSED_CODE:         # Check if pair quote currency equals to the stake currency.
# REMOVED_UNUSED_CODE:         stake_currency = self._freqtrade.config.get("stake_currency")
# REMOVED_UNUSED_CODE:         if not self._freqtrade.exchange.get_pair_quote_currency(pair) == stake_currency:
# REMOVED_UNUSED_CODE:             raise RPCException(
# REMOVED_UNUSED_CODE:                 f"Wrong pair selected. Only pairs with stake-currency {stake_currency} allowed."
# REMOVED_UNUSED_CODE:             )
...
# REMOVED_UNUSED_CODE:     def _rpc_locks(self) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:         """Returns the  current locks"""
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         locks = PairLocks.get_pair_locks(None)
# REMOVED_UNUSED_CODE:         return {"lock_count": len(locks), "locks": [lock.to_json() for lock in locks]}
...
# REMOVED_UNUSED_CODE:     def _rpc_blacklist(self, add: list[str] | None = None) -> dict:
# REMOVED_UNUSED_CODE:         """Returns the currently active blacklist"""
# REMOVED_UNUSED_CODE:         errors = {}
# REMOVED_UNUSED_CODE:         if add:
# REMOVED_UNUSED_CODE:             for pair in add:
# REMOVED_UNUSED_CODE:                 if pair not in self._freqtrade.pairlists.blacklist:
# REMOVED_UNUSED_CODE:                     try:
# REMOVED_UNUSED_CODE:                         expand_pairlist([pair], list(self._freqtrade.exchange.get_markets().keys()))
# REMOVED_UNUSED_CODE:                         self._freqtrade.pairlists.blacklist.append(pair)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:                     except ValueError:
# REMOVED_UNUSED_CODE:                         errors[pair] = {"error_msg": f"Pair {pair} is not a valid wildcard."}
# REMOVED_UNUSED_CODE:                 else:
# REMOVED_UNUSED_CODE:                     errors[pair] = {"error_msg": f"Pair {pair} already in pairlist."}
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         res = {
# REMOVED_UNUSED_CODE:             "method": self._freqtrade.pairlists.name_list,
# REMOVED_UNUSED_CODE:             "length": len(self._freqtrade.pairlists.blacklist),
# REMOVED_UNUSED_CODE:             "blacklist": self._freqtrade.pairlists.blacklist,
# REMOVED_UNUSED_CODE:             "blacklist_expanded": self._freqtrade.pairlists.expanded_blacklist,
# REMOVED_UNUSED_CODE:             "errors": errors,
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:         return res

# REMOVED_UNUSED_CODE:     @staticmethod
# REMOVED_UNUSED_CODE:     def _rpc_get_logs(limit: int | None) -> dict[str, Any]:
# REMOVED_UNUSED_CODE:         """Returns the last X logs"""
# REMOVED_UNUSED_CODE:         if limit:
# REMOVED_UNUSED_CODE:             buffer = bufferHandler.buffer[-limit:]
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             buffer = bufferHandler.buffer
# REMOVED_UNUSED_CODE:         records = [
# REMOVED_UNUSED_CODE:             [
# REMOVED_UNUSED_CODE:                 format_date(datetime.fromtimestamp(r.created)),
# REMOVED_UNUSED_CODE:                 r.created * 1000,
# REMOVED_UNUSED_CODE:                 r.name,
# REMOVED_UNUSED_CODE:                 r.levelname,
# REMOVED_UNUSED_CODE:                 r.message + ("\n" + r.exc_text if r.exc_text else ""),
# REMOVED_UNUSED_CODE:             ]
# REMOVED_UNUSED_CODE:             for r in buffer
# REMOVED_UNUSED_CODE:             if hasattr(r, "message")
# REMOVED_UNUSED_CODE:         ]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         # Log format:
# REMOVED_UNUSED_CODE:         # [logtime-formatted, logepoch, logger-name, loglevel, message \n + exception]
# REMOVED_UNUSED_CODE:         # e.g. ["2020-08-27 11:35:01", 1598520901097.9397,
# REMOVED_UNUSED_CODE:         #       "freqtrade.worker", "INFO", "Starting worker develop"]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         return {"log_count": len(records), "logs": records}
