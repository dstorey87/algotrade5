...
# REMOVED_UNUSED_CODE:     Exchange._ccxt_params = {"hello": "world"}
    ex = Exchange(conf)

    assert log_has("Applying additional ccxt config: {'TestKWARG': 11, 'TestKWARG44': 11}", caplog)
    assert ex._api.hello == "world"
    assert ex._ccxt_config == {}
# REMOVED_UNUSED_CODE:     Exchange._headers = {}
...
def test_create_dry_run_order_fees(
    ...
    order_type,
    is_short,
# REMOVED_UNUSED_CODE:     order_reason,
    price_side,
    fee,
):
    exchange = get_patched_exchange(mocker, default_conf)
    mocker.patch(
        f"{EXMS}.get_fee",
# REMOVED_UNUSED_CODE:         side_effect=lambda symbol, taker_or_maker: 2.0 if taker_or_maker == "taker" else 1.0,
    )
...
# REMOVED_UNUSED_CODE:     api_mock.options = {} if not marketprice else {"createMarketBuyOrderRequiresPrice": True}
    api_mock.create_order = MagicMock(
        return_value={"id": order_id, "info": {"foo": "bar"}, "symbol": "XLTCUSDT", "amount": 1}
    )
    default_conf["dry_run"] = False
    default_conf["margin_mode"] = "isolated"
# REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.amount_to_precision", lambda s, x, y: y)
# REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.price_to_precision", lambda s, x, y: y)
    exchange = get_patched_exchange(mocker, default_conf, api_mock, exchange=exchange_name)
...
def test_buy_prod(default_conf, mocker, exchange_name):
    ...
    order_type = "market"
    time_in_force = "gtc"
# REMOVED_UNUSED_CODE:     api_mock.options = {}
    api_mock.create_order = MagicMock(
...
# REMOVED_UNUSED_CODE:     balance_item = {"free": 10.0, "total": 10.0, "used": 0.0}

    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     api_mock.fetch_balance = MagicMock(
# REMOVED_UNUSED_CODE:         return_value={"1ST": balance_item, "2ND": balance_item, "3RD": balance_item}
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     api_mock.commonCurrencies = {}
    default_conf["dry_run"] = False
    exchange = get_patched_exchange(mocker, default_conf, api_mock, exchange=exchange_name)
...
def test_get_historic_ohlcv(default_conf, mocker, caplog, exchange_name, candle_type):
    ...
    exchange = get_patched_exchange(mocker, default_conf, exchange=exchange_name)
    pair = "ETH/BTC"
# REMOVED_UNUSED_CODE:     calls = 0
    now = dt_now()

# REMOVED_UNUSED_CODE:     async def mock_candle_hist(pair, timeframe, candle_type, since_ms):
# REMOVED_UNUSED_CODE:         nonlocal calls
# REMOVED_UNUSED_CODE:         calls += 1
# REMOVED_UNUSED_CODE:         ohlcv = [
# REMOVED_UNUSED_CODE:             [
# REMOVED_UNUSED_CODE:                 dt_ts(now + timedelta(minutes=5 * (calls + i))),  # unix timestamp ms
# REMOVED_UNUSED_CODE:                 1,  # open
# REMOVED_UNUSED_CODE:                 2,  # high
# REMOVED_UNUSED_CODE:                 3,  # low
# REMOVED_UNUSED_CODE:                 4,  # close
# REMOVED_UNUSED_CODE:                 5,  # volume (in quote currency)
# REMOVED_UNUSED_CODE:             ]
# REMOVED_UNUSED_CODE:             for i in range(2)
# REMOVED_UNUSED_CODE:         ]
# REMOVED_UNUSED_CODE:         return (pair, timeframe, candle_type, ohlcv, True)
...
# REMOVED_UNUSED_CODE:     async def mock_get_candle_hist_error(pair, *args, **kwargs):
# REMOVED_UNUSED_CODE:         raise TimeoutError()
...
# REMOVED_UNUSED_CODE:     exchange.required_candle_call_count = 2
    ...
    exchange._api_async.fetch_ohlcv.reset_mock()
# REMOVED_UNUSED_CODE:     exchange.required_candle_call_count = 1
...
# REMOVED_UNUSED_CODE:     async def mock_get_candle_hist(pair, *args, **kwargs):
# REMOVED_UNUSED_CODE:         if pair == "ETH/BTC":
...
# REMOVED_UNUSED_CODE:     pagination_arg = exchange._trades_pagination_arg

# REMOVED_UNUSED_CODE:     async def mock_get_trade_hist(pair, *args, **kwargs):
# REMOVED_UNUSED_CODE:         if "since" in kwargs:
# REMOVED_UNUSED_CODE:             # Return first 3
# REMOVED_UNUSED_CODE:             return fetch_trades_result[:-2]
# REMOVED_UNUSED_CODE:         elif kwargs.get("params", {}).get(pagination_arg) in (
# REMOVED_UNUSED_CODE:             fetch_trades_result[-3]["id"],
# REMOVED_UNUSED_CODE:             1565798399752,
# REMOVED_UNUSED_CODE:         ):
# REMOVED_UNUSED_CODE:             # Return 2
# REMOVED_UNUSED_CODE:             return fetch_trades_result[-3:-1]
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             # Return last 2
# REMOVED_UNUSED_CODE:             return fetch_trades_result[-2:]
...
# REMOVED_UNUSED_CODE:     async def mock_get_trade_hist(pair, *args, **kwargs):
# REMOVED_UNUSED_CODE:         if kwargs["since"] == fetch_trades_result[0]["timestamp"]:
# REMOVED_UNUSED_CODE:             return fetch_trades_result[:-1]
# REMOVED_UNUSED_CODE:         else:
# REMOVED_UNUSED_CODE:             return fetch_trades_result[-1:]
...
# REMOVED_UNUSED_CODE:     async def mock_get_trade_hist(pair, *args, **kwargs):
# REMOVED_UNUSED_CODE:         if kwargs["since"] == trades_history[0][0]:
# REMOVED_UNUSED_CODE:             return trades_history[:-1], trades_history[:-1][-1][0]
# REMOVED_UNUSED_CODE:         else:
...
def test_fetch_order(default_conf, mocker, exchange_name, caplog):
    ...
    order = MagicMock()
    order.myid = 123
# REMOVED_UNUSED_CODE:     order.symbol = "TKN/BTC"
...
def test__get_funding_fees_from_exchange(default_conf, mocker, exchange_name):
    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     api_mock.fetch_funding_history = MagicMock(
# REMOVED_UNUSED_CODE:         return_value=[
# REMOVED_UNUSED_CODE:             {
# REMOVED_UNUSED_CODE:                 "amount": 0.14542,
# REMOVED_UNUSED_CODE:                 "code": "USDT",
# REMOVED_UNUSED_CODE:                 "datetime": "2021-09-01T08:00:01.000Z",
# REMOVED_UNUSED_CODE:                 "id": "485478",
# REMOVED_UNUSED_CODE:                 "info": {
# REMOVED_UNUSED_CODE:                     "asset": "USDT",
# REMOVED_UNUSED_CODE:                     "income": "0.14542",
# REMOVED_UNUSED_CODE:                     "incomeType": "FUNDING_FEE",
# REMOVED_UNUSED_CODE:                     "info": "FUNDING_FEE",
# REMOVED_UNUSED_CODE:                     "symbol": "XRPUSDT",
# REMOVED_UNUSED_CODE:                     "time": "1630382001000",
# REMOVED_UNUSED_CODE:                     "tradeId": "",
# REMOVED_UNUSED_CODE:                     "tranId": "993203",
# REMOVED_UNUSED_CODE:                 },
# REMOVED_UNUSED_CODE:                 "symbol": "XRP/USDT",
# REMOVED_UNUSED_CODE:                 "timestamp": 1630382001000,
# REMOVED_UNUSED_CODE:             },
# REMOVED_UNUSED_CODE:             {
# REMOVED_UNUSED_CODE:                 "amount": -0.14642,
# REMOVED_UNUSED_CODE:                 "code": "USDT",
# REMOVED_UNUSED_CODE:                 "datetime": "2021-09-01T16:00:01.000Z",
# REMOVED_UNUSED_CODE:                 "id": "485479",
# REMOVED_UNUSED_CODE:                 "info": {
# REMOVED_UNUSED_CODE:                     "asset": "USDT",
# REMOVED_UNUSED_CODE:                     "income": "-0.14642",
# REMOVED_UNUSED_CODE:                     "incomeType": "FUNDING_FEE",
# REMOVED_UNUSED_CODE:                     "info": "FUNDING_FEE",
# REMOVED_UNUSED_CODE:                     "symbol": "XRPUSDT",
# REMOVED_UNUSED_CODE:                     "time": "1630314001000",
# REMOVED_UNUSED_CODE:                     "tradeId": "",
# REMOVED_UNUSED_CODE:                     "tranId": "993204",
# REMOVED_UNUSED_CODE:                 },
# REMOVED_UNUSED_CODE:                 "symbol": "XRP/USDT",
# REMOVED_UNUSED_CODE:                 "timestamp": 1630314001000,
# REMOVED_UNUSED_CODE:             },
# REMOVED_UNUSED_CODE:         ]
# REMOVED_UNUSED_CODE:     )
...
def test__fetch_and_calculate_funding_fees(
    mocker,
    default_conf,
# REMOVED_UNUSED_CODE:     funding_rate_history_hourly,
# REMOVED_UNUSED_CODE:     funding_rate_history_octohourly,
# REMOVED_UNUSED_CODE:     rate_start,
# REMOVED_UNUSED_CODE:     rate_end,
    mark_ohlcv,
    exchange,
    d1,
    d2,
...
# REMOVED_UNUSED_CODE:     funding_rate_history = {
# REMOVED_UNUSED_CODE:         "binance": funding_rate_history_octohourly,
# REMOVED_UNUSED_CODE:         "gate": funding_rate_history_octohourly,
# REMOVED_UNUSED_CODE:     }[exchange][rate_start:rate_end]
    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     api_mock.fetch_funding_rate_history = get_mock_coro(return_value=funding_rate_history)
...
# REMOVED_UNUSED_CODE:     funding_rate_history_octohourly,
    ...
    api_mock = MagicMock()
    api_mock.fetch_ohlcv = get_mock_coro(return_value=mark_ohlcv)
# REMOVED_UNUSED_CODE:     api_mock.fetch_funding_rate_history = get_mock_coro(
# REMOVED_UNUSED_CODE:         return_value=funding_rate_history_octohourly
# REMOVED_UNUSED_CODE:     )
    type(api_mock).has = PropertyMock(return_value={"fetchOHLCV": True})
    type(api_mock).has = PropertyMock(return_value={"fetchFundingRateHistory": True})
...
def test_load_leverage_tiers(mocker, default_conf, exchange_name):
    ...
    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     api_mock.fetch_leverage_tiers = MagicMock()
...
# REMOVED_UNUSED_CODE:     api_mock.fetch_leverage_tiers = MagicMock(
# REMOVED_UNUSED_CODE:         return_value={
# REMOVED_UNUSED_CODE:             "ADA/USDT:USDT": [
# REMOVED_UNUSED_CODE:                 {
# REMOVED_UNUSED_CODE:                     "tier": 1,
# REMOVED_UNUSED_CODE:                     "minNotional": 0,
# REMOVED_UNUSED_CODE:                     "maxNotional": 500,
# REMOVED_UNUSED_CODE:                     "maintenanceMarginRate": 0.02,
# REMOVED_UNUSED_CODE:                     "maxLeverage": 75,
# REMOVED_UNUSED_CODE:                     "info": {
# REMOVED_UNUSED_CODE:                         "baseMaxLoan": "",
# REMOVED_UNUSED_CODE:                         "imr": "0.013",
# REMOVED_UNUSED_CODE:                         "instId": "",
# REMOVED_UNUSED_CODE:                         "maxLever": "75",
# REMOVED_UNUSED_CODE:                         "maxSz": "500",
# REMOVED_UNUSED_CODE:                         "minSz": "0",
# REMOVED_UNUSED_CODE:                         "mmr": "0.01",
# REMOVED_UNUSED_CODE:                         "optMgnFactor": "0",
# REMOVED_UNUSED_CODE:                         "quoteMaxLoan": "",
# REMOVED_UNUSED_CODE:                         "tier": "1",
# REMOVED_UNUSED_CODE:                         "uly": "ADA-USDT",
# REMOVED_UNUSED_CODE:                     },
# REMOVED_UNUSED_CODE:                 },
# REMOVED_UNUSED_CODE:             ]
# REMOVED_UNUSED_CODE:         }
...
# REMOVED_UNUSED_CODE: def test_get_maintenance_ratio_and_amt_exceptions(mocker, default_conf, leverage_tiers):
# REMOVED_UNUSED_CODE:     api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     default_conf["trading_mode"] = "futures"
# REMOVED_UNUSED_CODE:     default_conf["margin_mode"] = "isolated"
# REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.exchange_has", return_value=True)
# REMOVED_UNUSED_CODE:     exchange = get_patched_exchange(mocker, default_conf, api_mock)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     exchange._leverage_tiers = leverage_tiers
# REMOVED_UNUSED_CODE:     with pytest.raises(
# REMOVED_UNUSED_CODE:         DependencyException,
# REMOVED_UNUSED_CODE:         match="nominal value can not be lower than 0",
# REMOVED_UNUSED_CODE:     ):
# REMOVED_UNUSED_CODE:         exchange.get_maintenance_ratio_and_amt("1000SHIB/USDT:USDT", -1)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     exchange._leverage_tiers = {}
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     with pytest.raises(
# REMOVED_UNUSED_CODE:         InvalidOrderException,
# REMOVED_UNUSED_CODE:         match="Maintenance margin rate for 1000SHIB/USDT:USDT is unavailable for",
# REMOVED_UNUSED_CODE:     ):
# REMOVED_UNUSED_CODE:         exchange.get_maintenance_ratio_and_amt("1000SHIB/USDT:USDT", 10000)
...
# REMOVED_UNUSED_CODE:     mocker, default_conf, leverage_tiers, pair, value, mmr, maintAmt
):
    api_mock = MagicMock()
    default_conf["trading_mode"] = "futures"
    default_conf["margin_mode"] = "isolated"
    mocker.patch(f"{EXMS}.exchange_has", return_value=True)
    exchange = get_patched_exchange(mocker, default_conf, api_mock)
# REMOVED_UNUSED_CODE:     exchange._leverage_tiers = leverage_tiers
    assert exchange.get_maintenance_ratio_and_amt(pair, value) == (mmr, maintAmt)


# REMOVED_UNUSED_CODE: def test_get_max_leverage_futures(default_conf, mocker, leverage_tiers):
# REMOVED_UNUSED_CODE:     # Test Spot
# REMOVED_UNUSED_CODE:     exchange = get_patched_exchange(mocker, default_conf, exchange="binance")
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BNB/USDT", 100.0) == 1.0
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Test Futures
# REMOVED_UNUSED_CODE:     default_conf["trading_mode"] = "futures"
# REMOVED_UNUSED_CODE:     default_conf["margin_mode"] = "isolated"
# REMOVED_UNUSED_CODE:     exchange = get_patched_exchange(mocker, default_conf, exchange="binance")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     exchange._leverage_tiers = leverage_tiers
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("XRP/USDT:USDT", 1.0) == 20.0
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BNB/USDT:USDT", 100.0) == 75.0
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BTC/USDT:USDT", 170.30) == 125.0
# REMOVED_UNUSED_CODE:     assert pytest.approx(exchange.get_max_leverage("XRP/USDT:USDT", 99999.9)) == 5.000005
# REMOVED_UNUSED_CODE:     assert pytest.approx(exchange.get_max_leverage("BNB/USDT:USDT", 1500)) == 33.333333333333333
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BTC/USDT:USDT", 300000000) == 2.0
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BTC/USDT:USDT", 600000000) == 1.0  # Last tier
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("SPONGE/USDT:USDT", 200) == 1.0  # Pair not in leverage_tiers
# REMOVED_UNUSED_CODE:     assert exchange.get_max_leverage("BTC/USDT:USDT", 0.0) == 125.0  # No stake amount
# REMOVED_UNUSED_CODE:     with pytest.raises(
# REMOVED_UNUSED_CODE:         InvalidOrderException, match=r"Amount 1000000000.01 too high for BTC/USDT:USDT"
# REMOVED_UNUSED_CODE:     ):
# REMOVED_UNUSED_CODE:         exchange.get_max_leverage("BTC/USDT:USDT", 1000000000.01)
...
def test__get_params(mocker, default_conf, exchange_name):
    ...
    mocker.patch(f"{EXMS}.exchange_has", return_value=True)
    exchange = get_patched_exchange(mocker, default_conf, api_mock, exchange=exchange_name)
# REMOVED_UNUSED_CODE:     exchange._params = {"test": True}
...
# REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.price_to_precision", lambda s, x, y, **kwargs: y)
    exchange = get_patched_exchange(mocker, default_conf_usdt, exchange=exchange_name)
