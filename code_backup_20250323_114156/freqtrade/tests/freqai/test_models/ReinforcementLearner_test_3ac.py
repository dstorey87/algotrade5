...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.freqai.RL.Base3ActionRLEnv import Actions, Base3ActionRLEnv, Positions
...
# REMOVED_UNUSED_CODE:     class MyRLEnv(Base3ActionRLEnv):
# REMOVED_UNUSED_CODE:         """
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 action in (Actions.Buy.value, Actions.Sell.value)
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             if self._position in (Positions.Short, Positions.Long) and (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 action == Actions.Neutral.value
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 or (action == Actions.Sell.value and self._position == Positions.Short)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 or (action == Actions.Buy.value and self._position == Positions.Long)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             ):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 return -1 * trade_duration / max_trade_duration
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             # close position
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             if (action == Actions.Buy.value and self._position == Positions.Short) or (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:                 action == Actions.Sell.value and self._position == Positions.Long
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             ):
