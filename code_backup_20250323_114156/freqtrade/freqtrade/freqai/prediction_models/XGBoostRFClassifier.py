...
# REMOVED_UNUSED_CODE: from pandas.api.types import is_integer_dtype
# REMOVED_UNUSED_CODE: from sklearn.preprocessing import LabelEncoder
# REMOVED_UNUSED_CODE: from xgboost import XGBRFClassifier
...
# REMOVED_UNUSED_CODE: class XGBoostRFClassifier(BaseClassifierModel):
# REMOVED_UNUSED_CODE:     """
...
# REMOVED_UNUSED_CODE:         if not is_integer_dtype(y):
# REMOVED_UNUSED_CODE:             y = pd.Series(le.fit_transform(y), dtype="int64")
# REMOVED_UNUSED_CODE: 
...
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             if not is_integer_dtype(test_labels):
# REMOVED_UNUSED_CODE:                 test_labels = pd.Series(le.transform(test_labels), dtype="int64")
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:             eval_set = [(test_features, test_labels)]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         train_weights = data_dictionary["train_weights"]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         init_model = self.get_init_model(dk.pair)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         model = XGBRFClassifier(**self.model_training_parameters)
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         model.fit(X=X, y=y, eval_set=eval_set, sample_weight=train_weights, xgb_model=init_model)
# REMOVED_UNUSED_CODE: 
