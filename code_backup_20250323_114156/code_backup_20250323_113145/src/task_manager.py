...
# REMOVED_UNUSED_CODE:     def update_task_status(self, task_id: str, status: str) -> bool:
# REMOVED_UNUSED_CODE:         """Update the status of a task.
# REMOVED_UNUSED_CODE:         
# REMOVED_UNUSED_CODE:         Args:
# REMOVED_UNUSED_CODE:             task_id: ID of the task
# REMOVED_UNUSED_CODE:             status: New status (pending, in_progress, completed, blocked)
# REMOVED_UNUSED_CODE:             
# REMOVED_UNUSED_CODE:         Returns:
# REMOVED_UNUSED_CODE:             bool: True if the task was updated, False otherwise
# REMOVED_UNUSED_CODE:         """
# REMOVED_UNUSED_CODE:         try:
# REMOVED_UNUSED_CODE:             # Find the task
# REMOVED_UNUSED_CODE:             for category_id, category in self.tasks["categories"].items():
# REMOVED_UNUSED_CODE:                 for task in category["tasks"]:
# REMOVED_UNUSED_CODE:                     if task["id"] == task_id:
# REMOVED_UNUSED_CODE:                         # Update status
# REMOVED_UNUSED_CODE:                         old_status = task["status"]
# REMOVED_UNUSED_CODE:                         task["status"] = status
# REMOVED_UNUSED_CODE:                         
# REMOVED_UNUSED_CODE:                         # If task is completed, move it to completed_tasks
# REMOVED_UNUSED_CODE:                         if status == "completed" and old_status != "completed":
# REMOVED_UNUSED_CODE:                             # Add to completed_tasks
# REMOVED_UNUSED_CODE:                             self.tasks["completed_tasks"].append({
# REMOVED_UNUSED_CODE:                                 "id": task_id,
# REMOVED_UNUSED_CODE:                                 "name": task["name"],
# REMOVED_UNUSED_CODE:                                 "completed_at": datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
# REMOVED_UNUSED_CODE:                             })
# REMOVED_UNUSED_CODE:                         
# REMOVED_UNUSED_CODE:                         # Save tasks
# REMOVED_UNUSED_CODE:                         self._save_tasks()
# REMOVED_UNUSED_CODE:                         
# REMOVED_UNUSED_CODE:                         logger.info(f"Updated task {task_id} status to {status}")
# REMOVED_UNUSED_CODE:                         
# REMOVED_UNUSED_CODE:                         return True
# REMOVED_UNUSED_CODE:             
# REMOVED_UNUSED_CODE:             logger.warning(f"Task {task_id} not found")
# REMOVED_UNUSED_CODE:             return False
# REMOVED_UNUSED_CODE:         except Exception as e:
# REMOVED_UNUSED_CODE:             logger.error(f"Error updating task status: {e}")
# REMOVED_UNUSED_CODE:             return False
