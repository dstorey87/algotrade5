...
# REMOVED_UNUSED_CODE: from unittest.mock import AsyncMock, MagicMock, PropertyMock
...
# REMOVED_UNUSED_CODE:     exchange.trading_mode = TradingMode.FUTURES
    # Default to netOnly
...
def test_load_leverage_tiers_okx(default_conf, mocker, markets, tmp_path, caplog, time_machine):
    ...
    api_mock = MagicMock()
# REMOVED_UNUSED_CODE:     type(api_mock).has = PropertyMock(
# REMOVED_UNUSED_CODE:         return_value={
# REMOVED_UNUSED_CODE:             "fetchLeverageTiers": False,
# REMOVED_UNUSED_CODE:             "fetchMarketLeverageTiers": True,
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:     )
    ...
    exchange = get_patched_exchange(mocker, default_conf, api_mock, exchange="okx")
# REMOVED_UNUSED_CODE:     exchange.trading_mode = TradingMode.FUTURES
# REMOVED_UNUSED_CODE:     exchange.margin_mode = MarginMode.ISOLATED
...
# REMOVED_UNUSED_CODE:     type(api_mock).has = PropertyMock(return_value={"setLeverage": True})
    default_conf["dry_run"] = False
...
# REMOVED_UNUSED_CODE: def test_stoploss_adjust_okx(mocker, default_conf, sl1, sl2, sl3, side):
# REMOVED_UNUSED_CODE:     exchange = get_patched_exchange(mocker, default_conf, exchange="okx")
# REMOVED_UNUSED_CODE:     order = {
# REMOVED_UNUSED_CODE:         "type": "stoploss",
# REMOVED_UNUSED_CODE:         "price": 1500,
# REMOVED_UNUSED_CODE:         "stopLossPrice": 1500,
# REMOVED_UNUSED_CODE:     }
# REMOVED_UNUSED_CODE:     assert exchange.stoploss_adjust(sl1, order, side=side)
# REMOVED_UNUSED_CODE:     assert not exchange.stoploss_adjust(sl2, order, side=side)
