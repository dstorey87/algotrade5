...
# REMOVED_UNUSED_CODE: from tests.conftest import EXMS, get_mock_coro, get_patched_exchange
...
# REMOVED_UNUSED_CODE:     api_mock.load_markets = get_mock_coro(return_value=markets)
...
# REMOVED_UNUSED_CODE:     type(api_mock).has = PropertyMock(return_value={"setMarginMode": True})
