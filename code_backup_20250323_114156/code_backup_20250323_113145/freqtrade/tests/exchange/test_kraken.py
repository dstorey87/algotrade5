...
# REMOVED_UNUSED_CODE: from tests.conftest import EXMS, get_patched_exchange
from tests.exchange.test_exchange import ccxt_exceptionhandlers


# REMOVED_UNUSED_CODE: STOPLOSS_ORDERTYPE = "stop-loss"
# REMOVED_UNUSED_CODE: STOPLOSS_LIMIT_ORDERTYPE = "stop-loss-limit"
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.amount_to_precision", lambda s, x, y: y)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.price_to_precision", lambda s, x, y, **kwargs: y)
...
# REMOVED_UNUSED_CODE:     balance_item = {"free": 0.0, "total": 10.0, "used": 0.0}
    kraken = ccxt.kraken()
...
# REMOVED_UNUSED_CODE:             "1ST": {"free": 0.0, "total": 0.0, "used": 0.0},
# REMOVED_UNUSED_CODE:             "1ST.F": balance_item.copy(),  # When "rewards" is enabled, the balance is in ".F"
# REMOVED_UNUSED_CODE:             "2ND": balance_item.copy(),
# REMOVED_UNUSED_CODE:             "3RD": balance_item.copy(),
# REMOVED_UNUSED_CODE:             "4TH": balance_item.copy(),
# REMOVED_UNUSED_CODE:             "EUR": balance_item.copy(),
# REMOVED_UNUSED_CODE:             "BTC": {"free": 0.0, "total": 0.0, "used": 0.0},
# REMOVED_UNUSED_CODE:             "XBT.F": balance_item.copy(),
# REMOVED_UNUSED_CODE:             "timestamp": 123123,
# REMOVED_UNUSED_CODE:         }
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     kraken_open_orders = [
# REMOVED_UNUSED_CODE:         {
# REMOVED_UNUSED_CODE:             "symbol": "1ST/EUR",
# REMOVED_UNUSED_CODE:             "type": "limit",
# REMOVED_UNUSED_CODE:             "side": "sell",
# REMOVED_UNUSED_CODE:             "price": 20,
# REMOVED_UNUSED_CODE:             "cost": 0.0,
# REMOVED_UNUSED_CODE:             "amount": 1.0,
# REMOVED_UNUSED_CODE:             "filled": 0.0,
# REMOVED_UNUSED_CODE:             "average": 0.0,
# REMOVED_UNUSED_CODE:             "remaining": 1.0,
# REMOVED_UNUSED_CODE:         },
# REMOVED_UNUSED_CODE:         {
# REMOVED_UNUSED_CODE:             "status": "open",
# REMOVED_UNUSED_CODE:             "symbol": "2ND/EUR",
# REMOVED_UNUSED_CODE:             "type": "limit",
# REMOVED_UNUSED_CODE:             "side": "sell",
# REMOVED_UNUSED_CODE:             "price": 20.0,
# REMOVED_UNUSED_CODE:             "cost": 0.0,
...
# REMOVED_UNUSED_CODE:         {
# REMOVED_UNUSED_CODE:             "status": "open",
# REMOVED_UNUSED_CODE:             "symbol": "2ND/USD",
# REMOVED_UNUSED_CODE:             "type": "limit",
# REMOVED_UNUSED_CODE:             "side": "sell",
# REMOVED_UNUSED_CODE:             "price": 20.0,
# REMOVED_UNUSED_CODE:             "cost": 0.0,
...
# REMOVED_UNUSED_CODE:         {
# REMOVED_UNUSED_CODE:             "status": "open",
# REMOVED_UNUSED_CODE:             "symbol": "3RD/EUR",
# REMOVED_UNUSED_CODE:             "type": "limit",
# REMOVED_UNUSED_CODE:             "side": "buy",
# REMOVED_UNUSED_CODE:             "price": 0.02,
# REMOVED_UNUSED_CODE:             "cost": 0.0,
...
# REMOVED_UNUSED_CODE:         },
# REMOVED_UNUSED_CODE:     ]
# REMOVED_UNUSED_CODE:     api_mock.fetch_open_orders = MagicMock(return_value=kraken_open_orders)
    default_conf["dry_run"] = False
    exchange = get_patched_exchange(mocker, default_conf, api_mock, exchange="kraken")
