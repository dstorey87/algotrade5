...
# REMOVED_UNUSED_CODE:     single_mock.return_value = lookahead_analysis
    text_table_mock = MagicMock()
    mocker.patch.multiple(
        "freqtrade.optimize.analysis.lookahead_helpers.LookaheadAnalysisSubFunctions",
        initialize_single_lookahead_analysis=single_mock,
...
# REMOVED_UNUSED_CODE:     analysis.total_signals = 5
# REMOVED_UNUSED_CODE:     analysis.false_entry_signals = 4
# REMOVED_UNUSED_CODE:     analysis.false_exit_signals = 3
...
# REMOVED_UNUSED_CODE:     analysis.total_signals = 12
# REMOVED_UNUSED_CODE:     analysis.false_entry_signals = 11
# REMOVED_UNUSED_CODE:     analysis.false_exit_signals = 10
    instance = LookaheadAnalysis(lookahead_conf, strategy_obj)
    instance.current_analysis = analysis
    data = LookaheadAnalysisSubFunctions.text_table_lookahead_analysis_instances(
        lookahead_conf, [instance]
...
# REMOVED_UNUSED_CODE:     instance.failed_bias_check = False
    data = LookaheadAnalysisSubFunctions.text_table_lookahead_analysis_instances(
        lookahead_conf, [instance]
    )
    assert data[0][0] == "strategy_test_v3_with_lookahead_bias.py"
...
# REMOVED_UNUSED_CODE:     analysis1.total_signals = 12
# REMOVED_UNUSED_CODE:     analysis1.false_entry_signals = 11
# REMOVED_UNUSED_CODE:     analysis1.false_exit_signals = 10
...
# REMOVED_UNUSED_CODE:     instance1.failed_bias_check = False
...
# REMOVED_UNUSED_CODE:     analysis2.total_signals = 22
# REMOVED_UNUSED_CODE:     analysis2.false_entry_signals = 21
# REMOVED_UNUSED_CODE:     analysis2.false_exit_signals = 20
...
# REMOVED_UNUSED_CODE:     instance2.failed_bias_check = False
...
# REMOVED_UNUSED_CODE:     analysis3.total_signals = 32
# REMOVED_UNUSED_CODE:     analysis3.false_entry_signals = 31
# REMOVED_UNUSED_CODE:     analysis3.false_exit_signals = 30
...
# REMOVED_UNUSED_CODE:     instance3.failed_bias_check = False
