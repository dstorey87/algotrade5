...
def test_may_execute_exit_stoploss_on_exchange_multi(default_conf, ticker, fee, mocker) -> None:
    ...
    * 3rd trade is sold via sell-signal
    ...
    mocker.patch.multiple(
        ...
        fetch_ticker=ticker,
        get_fee=fee,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         amount_to_precision=lambda s, x, y: y,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         price_to_precision=lambda s, x, y: y,
...
def test_dca_short(default_conf_usdt, ticker_usdt, fee, mocker) -> None:
    ...
    mocker.patch.multiple(
        ...
        fetch_ticker=ticker_usdt,
        get_fee=fee,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         amount_to_precision=lambda s, x, y: round(y, 4),
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         price_to_precision=lambda s, x, y: y,
    )
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         price_to_precision=lambda s, x, y: y,
    ...
    patch_get_signal(freqtrade)
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     freqtrade.strategy.custom_entry_price = lambda **kwargs: ticker_usdt["ask"] * 0.96
    freqtrade.strategy.leverage = MagicMock(return_value=leverage)
# REMOVED_UNUSED_CODE:     freqtrade.strategy.minimal_roi = {0: 0.2}
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     mocker.patch(f"{EXMS}.amount_to_contract_precision", lambda s, p, v: round(v, 1))
...
# REMOVED_UNUSED_CODE:     freqtrade.exchange.amount_to_contract_precision = MagicMock(return_value=2)
...
# REMOVED_UNUSED_CODE:     freqtrade.exchange.amount_to_contract_precision = MagicMock(return_value=3)
...
# REMOVED_UNUSED_CODE:     freqtrade.strategy.custom_exit_price = MagicMock(return_value=1.95)
    freqtrade.process()
    # Even with open order, trying to exit...
    assert freqtrade.strategy.custom_exit.call_count == 1
    freqtrade.strategy.custom_exit.reset_mock()
