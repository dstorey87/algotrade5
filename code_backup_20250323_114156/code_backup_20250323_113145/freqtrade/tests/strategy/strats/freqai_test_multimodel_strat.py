...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         dataframe["&-s_close"] = (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             dataframe["close"]
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .shift(-self.freqai_info["feature_parameters"]["label_period_candles"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .rolling(self.freqai_info["feature_parameters"]["label_period_candles"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .mean()
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             / dataframe["close"]
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             - 1
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         dataframe["&-s_range"] = (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             dataframe["close"]
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .shift(-self.freqai_info["feature_parameters"]["label_period_candles"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .rolling(self.freqai_info["feature_parameters"]["label_period_candles"])
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .shift(-self.freqai_info["feature_parameters"]["label_period_candles"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .rolling(self.freqai_info["feature_parameters"]["label_period_candles"])
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             .min()
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         return dataframe

# REMOVED_UNUSED_CODE:     def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
# REMOVED_UNUSED_CODE:         self.freqai_info = self.config["freqai"]
# REMOVED_UNUSED_CODE: 
