...
# REMOVED_UNUSED_CODE:     s.started = True
    s.run_in_thread()
...
# REMOVED_UNUSED_CODE: def test_api_UvicornServer_run_no_uvloop(mocker, import_fails):
# REMOVED_UNUSED_CODE:     serve_mock = mocker.patch(
# REMOVED_UNUSED_CODE:         "freqtrade.rpc.api_server.uvicorn_threaded.UvicornServer.serve", get_mock_coro(None)
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE:     asyncio.set_event_loop(asyncio.new_event_loop())
# REMOVED_UNUSED_CODE:     s = UvicornServer(uvicorn.Config(MagicMock(), port=8080, host="127.0.0.1"))
# REMOVED_UNUSED_CODE:     assert serve_mock.call_count == 0
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     # Fake started to avoid sleeping forever
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     s.started = True
# REMOVED_UNUSED_CODE:     s.run()
# REMOVED_UNUSED_CODE:     assert serve_mock.call_count == 1
...
def test_api_run(default_conf, mocker, caplog):
    ...
    server_mock.reset_mock()
# REMOVED_UNUSED_CODE:     apiserver._standalone = True
    apiserver.start_api()
...
# REMOVED_UNUSED_CODE:     apiserver._standalone = False
...
# REMOVED_UNUSED_CODE:     ApiBG.pairlist_running = False
    rc = client_post(client, f"{BASE_URI}/pairlists/evaluate", body)
    assert_response(rc)
...
# REMOVED_UNUSED_CODE:         ApiBG.bgtask_running = False
...
# REMOVED_UNUSED_CODE:     ApiBG.download_data_running = True
    ...
    # Reset running state
# REMOVED_UNUSED_CODE:     ApiBG.download_data_running = False
