...
# REMOVED_UNUSED_CODE:     async def eat(websocket):
# REMOVED_UNUSED_CODE:         emc._running = False
...
async def test_emc_receive_messages_valid(default_conf, caplog, mocker):
    ...
    class TestChannel:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         async def recv(self, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             emc._running = False
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             return {"type": "whitelist", "data": ["BTC/USDT"]}

# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         async def ping(self, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             return asyncio.Future()
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         async def recv(self, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             emc._running = False
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             return {"type": ["BTC/USDT"]}
...
async def test_emc_receive_messages_timeout(default_conf, caplog, mocker):
    ...
    class TestChannel:
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:         async def recv(self, *args, **kwargs):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:             await asyncio.sleep(0.2)
