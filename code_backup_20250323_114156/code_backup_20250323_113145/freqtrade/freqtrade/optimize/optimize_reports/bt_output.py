...
# REMOVED_UNUSED_CODE: def show_sorted_pairlist(config: Config, backtest_stats: BacktestResultType):
# REMOVED_UNUSED_CODE:     if config.get("backtest_show_pair_list", False):
# REMOVED_UNUSED_CODE:         for strategy, results in backtest_stats["strategy"].items():
# REMOVED_UNUSED_CODE:             print(f"Pairs for Strategy {strategy}: \n[")
# REMOVED_UNUSED_CODE:             for result in results["results_per_pair"]:
# REMOVED_UNUSED_CODE:                 if result["key"] != "TOTAL":
# REMOVED_UNUSED_CODE:                     print(f'"{result["key"]}",  // {result["profit_mean"]:.2%}')
# REMOVED_UNUSED_CODE:             print("]")


# REMOVED_UNUSED_CODE: def generate_edge_table(results: dict) -> None:
# REMOVED_UNUSED_CODE:     tabular_data = []
# REMOVED_UNUSED_CODE:     headers = [
# REMOVED_UNUSED_CODE:         "Pair",
# REMOVED_UNUSED_CODE:         "Stoploss",
# REMOVED_UNUSED_CODE:         "Win Rate",
# REMOVED_UNUSED_CODE:         "Risk Reward Ratio",
# REMOVED_UNUSED_CODE:         "Required Risk Reward",
# REMOVED_UNUSED_CODE:         "Expectancy",
# REMOVED_UNUSED_CODE:         "Total Number of Trades",
# REMOVED_UNUSED_CODE:         "Average Duration (min)",
# REMOVED_UNUSED_CODE:     ]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     for result in results.items():
# REMOVED_UNUSED_CODE:         if result[1].nb_trades > 0:
# REMOVED_UNUSED_CODE:             tabular_data.append(
# REMOVED_UNUSED_CODE:                 [
# REMOVED_UNUSED_CODE:                     result[0],
# REMOVED_UNUSED_CODE:                     f"{result[1].stoploss:.10g}",
# REMOVED_UNUSED_CODE:                     f"{result[1].winrate:.2f}",
# REMOVED_UNUSED_CODE:                     f"{result[1].risk_reward_ratio:.2f}",
# REMOVED_UNUSED_CODE:                     f"{result[1].required_risk_reward:.2f}",
# REMOVED_UNUSED_CODE:                     f"{result[1].expectancy:.2f}",
# REMOVED_UNUSED_CODE:                     result[1].nb_trades,
# REMOVED_UNUSED_CODE:                     round(result[1].avg_trade_duration),
# REMOVED_UNUSED_CODE:                 ]
# REMOVED_UNUSED_CODE:             )
# REMOVED_UNUSED_CODE:     print_rich_table(tabular_data, headers, summary="EDGE TABLE")
