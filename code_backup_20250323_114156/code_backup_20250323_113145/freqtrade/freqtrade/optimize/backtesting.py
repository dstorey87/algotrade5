...
# REMOVED_UNUSED_CODE: from numpy import nan
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.constants import DATETIME_PRINT_FORMAT, Config, IntOrInf, LongShort
# REMOVED_UNUSED_CODE: from freqtrade.data import history
# REMOVED_UNUSED_CODE: from freqtrade.data.btanalysis import find_existing_backtest_stats, trade_list_to_dataframe
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.data.converter import trim_dataframe, trim_dataframes
# REMOVED_UNUSED_CODE: from freqtrade.data.dataprovider import DataProvider
# REMOVED_UNUSED_CODE: from freqtrade.data.metrics import combined_dataframes_with_rel_mean
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     BacktestState,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     CandleType,
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     RunMode,
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.exceptions import DependencyException, OperationalException
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.exchange import (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     amount_to_contract_precision,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     price_to_precision,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     timeframe_to_seconds,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: )
# REMOVED_UNUSED_CODE: from freqtrade.exchange.exchange import Exchange
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.ft_types import BacktestResultType, get_BacktestResultType_default
...
# REMOVED_UNUSED_CODE: from freqtrade.optimize.backtest_caching import get_strategy_run_id
# REMOVED_UNUSED_CODE: from freqtrade.optimize.bt_progress import BTProgress
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.optimize.optimize_reports import (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     generate_backtest_stats,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     generate_rejected_signals,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     generate_trade_signal_candles,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     show_backtest_results,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     store_backtest_results,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: )
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.persistence import (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     CustomDataWrapper,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     LocalTrade,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Order,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     PairLocks,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     Trade,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     disable_database_use,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     enable_database_use,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: )
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.util import FtPrecise, dt_now
...
# REMOVED_UNUSED_CODE: DATE_IDX = 0
# REMOVED_UNUSED_CODE: OPEN_IDX = 1
# REMOVED_UNUSED_CODE: HIGH_IDX = 2
# REMOVED_UNUSED_CODE: LOW_IDX = 3
# REMOVED_UNUSED_CODE: CLOSE_IDX = 4
# REMOVED_UNUSED_CODE: LONG_IDX = 5
# REMOVED_UNUSED_CODE: ELONG_IDX = 6  # Exit long
# REMOVED_UNUSED_CODE: SHORT_IDX = 7
# REMOVED_UNUSED_CODE: ESHORT_IDX = 8  # Exit short
# REMOVED_UNUSED_CODE: ENTER_TAG_IDX = 9
# REMOVED_UNUSED_CODE: EXIT_TAG_IDX = 10

# Every change to this headers list must evaluate further usages of the resulting tuple
# and eventually change the constants for indexes at the top
# REMOVED_UNUSED_CODE: HEADERS = [
# REMOVED_UNUSED_CODE:     "date",
# REMOVED_UNUSED_CODE:     "open",
# REMOVED_UNUSED_CODE:     "high",
# REMOVED_UNUSED_CODE:     "low",
# REMOVED_UNUSED_CODE:     "close",
# REMOVED_UNUSED_CODE:     "enter_long",
# REMOVED_UNUSED_CODE:     "exit_long",
# REMOVED_UNUSED_CODE:     "enter_short",
# REMOVED_UNUSED_CODE:     "exit_short",
# REMOVED_UNUSED_CODE:     "enter_tag",
# REMOVED_UNUSED_CODE:     "exit_tag",
# REMOVED_UNUSED_CODE: ]
