...
import logging
# REMOVED_UNUSED_CODE: import socket
...
# REMOVED_UNUSED_CODE: import websockets
# REMOVED_UNUSED_CODE: from pydantic import ValidationError

# REMOVED_UNUSED_CODE: from freqtrade.constants import FULL_DATAFRAME_THRESHOLD
...
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.rpc.api_server.ws.channel import WebSocketChannel, create_channel
# REMOVED_UNUSED_CODE: from freqtrade.rpc.api_server.ws.message_stream import MessageStream
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.rpc.api_server.ws_schemas import (
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSAnalyzedDFMessage,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSAnalyzedDFRequest,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSMessageSchema,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSRequestSchema,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSSubscribeRequest,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSWhitelistMessage,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     WSWhitelistRequest,
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: )


# REMOVED_UNUSED_CODE: class Producer(TypedDict):
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     name: str
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     host: str
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE:     port: int
...
# REMOVED_UNUSED_CODE: def schema_to_dict(schema: WSMessageSchema | WSRequestSchema):
# REMOVED_UNUSED_CODE:     return schema.model_dump(exclude_none=True)
