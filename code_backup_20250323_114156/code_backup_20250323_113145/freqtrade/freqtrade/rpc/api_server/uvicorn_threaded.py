...
# REMOVED_UNUSED_CODE: import uvicorn


# REMOVED_UNUSED_CODE: def asyncio_setup() -> None:  # pragma: no cover
# REMOVED_UNUSED_CODE:     # Set eventloop for win32 setups
# REMOVED_UNUSED_CODE:     # Reverts a change done in uvicorn 0.15.0 - which now sets the eventloop
# REMOVED_UNUSED_CODE:     # via policy.
# REMOVED_UNUSED_CODE:     # TODO: is this workaround actually needed?
# REMOVED_UNUSED_CODE:     import sys
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     if sys.version_info >= (3, 8) and sys.platform == "win32":
# REMOVED_UNUSED_CODE:         import asyncio
# REMOVED_UNUSED_CODE:         import selectors
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:         selector = selectors.SelectSelector()
# REMOVED_UNUSED_CODE:         loop = asyncio.SelectorEventLoop(selector)
# REMOVED_UNUSED_CODE:         asyncio.set_event_loop(loop)
