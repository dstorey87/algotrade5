...
# REMOVED_UNUSED_CODE: from freqtrade.constants import DATETIME_PRINT_FORMAT, DL_DATA_TIMEFRAMES, Config
# REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: # REMOVED_UNUSED_CODE: from freqtrade.enums import CandleType, RunMode, TradingMode
...
# REMOVED_UNUSED_CODE: def _check_data_config_download_sanity(config: Config) -> None:
# REMOVED_UNUSED_CODE:     if "days" in config and "timerange" in config:
# REMOVED_UNUSED_CODE:         raise ConfigurationError(
# REMOVED_UNUSED_CODE:             "--days and --timerange are mutually exclusive. You can only specify one or the other."
# REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     if "pairs" not in config:
# REMOVED_UNUSED_CODE:         raise ConfigurationError(
# REMOVED_UNUSED_CODE:             "Downloading data requires a list of pairs. "
# REMOVED_UNUSED_CODE:             "Please check the documentation on how to configure this."
# REMOVED_UNUSED_CODE:         )
...
# REMOVED_UNUSED_CODE: def start_list_trades_data(args: dict[str, Any]) -> None:
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     List available Trades data
# REMOVED_UNUSED_CODE:     """
# REMOVED_UNUSED_CODE:     from freqtrade.configuration import setup_utils_configuration
...
# REMOVED_UNUSED_CODE:     from freqtrade.data.history import get_datahandler
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     dhc = get_datahandler(config["datadir"], config["dataformat_trades"])
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     paircombs = dhc.trades_get_available_data(
# REMOVED_UNUSED_CODE:         config["datadir"], config.get("trading_mode", TradingMode.SPOT)
# REMOVED_UNUSED_CODE:     )
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     if args["pairs"]:
# REMOVED_UNUSED_CODE:         paircombs = [comb for comb in paircombs if comb in args["pairs"]]
# REMOVED_UNUSED_CODE: 
# REMOVED_UNUSED_CODE:     title = f"Found trades data for {len(paircombs)} {plural(len(paircombs), 'pair')}."
# REMOVED_UNUSED_CODE:     if not config.get("show_timerange"):
# REMOVED_UNUSED_CODE:         print_rich_table(
# REMOVED_UNUSED_CODE:             [(pair, config.get("candle_type_def", CandleType.SPOT)) for pair in sorted(paircombs)],
# REMOVED_UNUSED_CODE:             ("Pair", "Type"),
# REMOVED_UNUSED_CODE:             title,
# REMOVED_UNUSED_CODE:             table_kwargs={"min_width": 50},
# REMOVED_UNUSED_CODE:         )
# REMOVED_UNUSED_CODE:     else:
# REMOVED_UNUSED_CODE:         paircombs1 = [
# REMOVED_UNUSED_CODE:             (pair, *dhc.trades_data_min_max(pair, config.get("trading_mode", TradingMode.SPOT)))
# REMOVED_UNUSED_CODE:             for pair in paircombs
# REMOVED_UNUSED_CODE:         ]
# REMOVED_UNUSED_CODE:         print_rich_table(
# REMOVED_UNUSED_CODE:             [
# REMOVED_UNUSED_CODE:                 (
# REMOVED_UNUSED_CODE:                     pair,
# REMOVED_UNUSED_CODE:                     config.get("candle_type_def", CandleType.SPOT),
# REMOVED_UNUSED_CODE:                     start.strftime(DATETIME_PRINT_FORMAT),
# REMOVED_UNUSED_CODE:                     end.strftime(DATETIME_PRINT_FORMAT),
# REMOVED_UNUSED_CODE:                     str(length),
# REMOVED_UNUSED_CODE:                 )
# REMOVED_UNUSED_CODE:                 for pair, start, end, length in sorted(paircombs1, key=lambda x: (x[0]))
# REMOVED_UNUSED_CODE:             ],
# REMOVED_UNUSED_CODE:             ("Pair", "Type", "From", "To", "Trades"),
# REMOVED_UNUSED_CODE:             summary=title,
# REMOVED_UNUSED_CODE:             table_kwargs={"min_width": 50},
# REMOVED_UNUSED_CODE:         )
